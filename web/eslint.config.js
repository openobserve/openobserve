...
export default [
  ...
  // ── Accessibility (WCAG audit Phase 0) ─────────────────────────────────────
  // Six rules the audit tied to specific Critical/Serious findings, at `error`
  // against a shrink-only per-file allowlist (pre-existing debt only — new
  // violations are blocked from day one, same shape as no-hardcoded-color).
  // Every other rule the plugin ships stays `off`: the plugin's own examples
  // (`no-noninteractive-element-interactions`, `no-autofocus`, etc.) are not
  // gated here on purpose — audit did not tie them to a finding, and adding
  // them all at once would misattribute violations to this PR's allowlist.
  //
  // tabindex-no-positive and role-has-required-aria-props had one offending
  // file each (O2AIConfirmDialog.vue, OTreeNode.vue) — fixed inline rather than
  // allowlisted, so both rules ship with zero exemptions.
  {
    files: ["**/*.vue"],
  ...
  // Pre-existing debt, measured when these rules were introduced (audit §2/§5/
  // Appendix C: ~160 real non-semantic clickables, 29 images without alt, ~25
  // unlabelled form controls). Each list must only ever SHRINK — remove a file's
  // entry only once it is actually clean of that rule; new files are never added.
  //
  // click-events-have-key-events' 94 files are a strict subset of the 127-file
  // interaction list below, so one shared list gates both — a file already on
  // notice for one non-semantic-interaction defect is on notice for the other.
  {
    files: [
      ...
      "src/components/O2AIConfirmDialog.vue",
      "src/components/OrganizationSelector.vue",
      "src/components/RichTextInput.vue",
      "src/components/alerts/AlertHistoryTimeline.vue",
      "src/components/alerts/AlertInsights.vue",
      "src/components/alerts/AlertInsightsContextMenu.vue",
      "src/components/alerts/AlertList.vue",
      "src/components/alerts/AlertSummary.vue",
      "src/components/alerts/DependencyImpactDialog.vue",
      ...
      "src/components/alerts/PrebuiltDestinationSelector.vue",
      "src/components/alerts/QueryEditorDialog.vue",
      "src/components/alerts/steps/QueryConfig.vue",
      "src/components/common/GroupedFieldList.vue",
      "src/components/common/sidebar/SearchFieldList.vue",
      "src/components/cross-linking/CrossLinkDialog.vue",
      "src/components/dashboards/AlertContextMenu.vue",
      "src/components/dashboards/DashboardLogDrawer.vue",
      "src/components/dashboards/PanelContainer.vue",
      "src/components/dashboards/PanelEditor/PanelEditor.vue",
      ...
      "src/components/dashboards/addPanel/Drilldown.vue",
      ...
      "src/components/dashboards/panels/ChartRenderer.vue",
      "src/components/dashboards/panels/CustomChartRenderer.vue",
      "src/components/dashboards/settings/VariableQueryValueSelector.vue",
      "src/components/dashboards/tabs/TabList.vue",
      "src/components/flow/FlowEdge.vue",
      "src/components/flow/StepPickerDialog.vue",
      "src/components/functions/EnrichmentTableList.vue",
      "src/components/functions/FullViewContainer.vue",
      ...
      "src/components/ingestion/setupCard/SetupCardRenderer.vue",
      ...
      "src/components/synthetic-monitoring/MonitorTable.vue",
      "src/components/synthetics/CheckTypePicker.vue",
      "src/components/synthetics/journey/JourneySteps.vue",
      "src/components/synthetics/results/ExecutionDetailDrawer.vue",
      "src/components/traces/FlameGraphView.vue",
      "src/components/workflows/WorkflowNodeDrawer.vue",
      "src/enterprise/components/AIObservability/PlaygroundMessageList.vue",
      "src/enterprise/components/onlineEvals/ScoreConfigLibrary.vue",
      "src/enterprise/components/onlineEvals/ScorerLibrary.vue",
      "src/enterprise/components/onlineEvals/quality/QualityKpiCard.vue",
      "src/lib/core/Navbar/ONavGroup.vue",
      "src/lib/core/Navbar/ONavbar.vue",
      "src/lib/core/Splitter/OSplitter.vue",
      "src/lib/core/Table/sub-components/OTableBodyCell.vue",
      "src/lib/core/Table/sub-components/OTableColumnToggle.vue",
      "src/lib/core/Table/sub-components/OTableHeader.vue",
      "src/lib/data/Tree/OTreeNode.vue",
      "src/lib/forms/EmojiPicker/OEmojiPicker.vue",
      "src/lib/forms/File/OFile.vue",
      "src/lib/forms/Select/OSelect.vue",
      "src/lib/forms/Switch/OSwitch.vue",
      "src/lib/lists/FieldList/OFieldList.vue",
      "src/lib/navigation/Tabs/OTabs.vue",
      ...
      "src/plugins/logs/patterns/PatternDetailsDialog.vue",
      "src/plugins/logs/patterns/WildcardValuePopover.vue",
      "src/plugins/metrics/explorer/FunctionConfigDialog.vue",
      "src/plugins/pipelines/CustomNode.vue",
      "src/plugins/pipelines/PipelineFlow.vue",
      "src/plugins/traces/SessionDetails.vue",
      "src/plugins/traces/SessionRibbon.vue",
      "src/plugins/traces/SpanBlock.vue",
      "src/plugins/traces/ThreadToolCalls.vue",
      ...
      "src/plugins/traces/TraceHeader.vue",
      "src/plugins/traces/TraceTree.vue",
      "src/plugins/traces/components/TracesSearchResultList.vue",
      "src/plugins/traces/metrics/TracesAnalysisDashboard.vue",
      "src/plugins/traces/metrics/TracesMetricsContextMenu.vue",
      "src/plugins/workflows/WorkflowCanvas.vue",
      "src/plugins/workflows/WorkflowNode.vue",
      "src/views/Dashboards/ScheduledDashboards.vue",
      "src/views/Dashboards/addPanel/AddPanel.vue",
      "src/views/HomeChatHistory.vue",
      "src/views/OverviewTab.vue",
      "src/views/RUM/SourceMapDropzone.vue",
      "src/views/synthetics/MonitorRuns.vue",
    ],
    rules: {
  ...
  },
  {
    files: [
      ...
      "src/components/O2AIChat.vue",
      "src/components/alerts/QueryEditorDialog.vue",
      "src/components/common/O2AIContextAddBtn.vue",
      "src/components/dashboards/addPanel/DashboardQueryEditor.vue",
      ...
      "src/enterprise/components/billings/plans.vue",
      "src/enterprise/components/billings/usage.vue",
      "src/views/About.vue",
  ...
  },
  {
    files: [
      ...
      "src/components/dashboards/tabs/TabList.vue",
      "src/components/settings/ImportSyntheticsLocations.vue",
      "src/enterprise/components/onlineEvals/forms/scorer/ScorerTestPanel.vue",
      "src/lib/core/Table/OTable.vue",
      "src/lib/forms/Color/OColor.vue",
      "src/lib/forms/DateTimeRange/ODateTimeRange.vue",
      "src/lib/forms/TagInput/OTagInput.vue",
      "src/lib/forms/Time/OTime.vue",
      "src/views/HomeChatHistory.vue",
      "src/views/RUM/SourceMapDropzone.vue",
    ],
    rules: {
