...
export const restHandlers = [
  ...
  http.get(
    `${store.state.API_ENDPOINT}/api/:org/re_patterns`,
    ({ request }) => {
      return HttpResponse.json(
        {
          data: regexPatterns,
  ...
  http.put(
    `${store.state.API_ENDPOINT}/api/:org/re_patterns/:id`,
  ...
  http.post(
    `${store.state.API_ENDPOINT}/api/:org/re_patterns/test`,
    async ({ request }) => {
      const body = (await request.json()) as any;
  ...
  http.post(
    `${store.state.API_ENDPOINT}/api/:org/settings`,
    async ({ request }) => {
      const body = (await request.json()) as any;
      return HttpResponse.json(
        {
  ...
  http.post(
    `${store.state.API_ENDPOINT}/api/:org/settings/logo`,
    async ({ request }) => {
  ...
  http.post(
    `${store.state.API_ENDPOINT}/api/:org/settings/logo/text`,
    async ({ request }) => {
