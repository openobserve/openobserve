      ...
      >
        <div class="flex flex-wrap items-center justify-between gap-14 px-10 py-12">
          ...
          <div class="max-w-120 min-w-70 flex-1">
            <div
              class="text-accent border-accent/25 bg-accent/10 mb-5 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-xs font-semibold tracking-[0.4px]"
            >
