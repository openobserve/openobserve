...
<template>
  <OCard class="flex flex-col shadow-none border border-(--color-card-glass-border) bg-(--color-card-glass-bg) rounded-lg w-full h-full dark:bg-[var(--color-surface-base)] dark:border-[var(--color-border-default)]">
