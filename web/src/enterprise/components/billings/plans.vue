...
<template>
  <div class="rounded-default px-4 pt-3 overflow-auto" style="min-height: inherit">
    ...
    >
      ...
      >
        <div
          class="w-17 h-17 rounded-full bg-[color-mix(in_srgb,var(--color-primary-600)_10%,transparent)] border-[1.5px] border-[color-mix(in_srgb,var(--color-primary-600)_24%,transparent)] border-solid flex items-center justify-center"
        >
      ...
      <div class="flex items-center gap-2 flex-wrap justify-center mb-8">
        <span
          class="inline-flex items-center gap-1.25 text-xs font-medium opacity-85 bg-[color-mix(in_srgb,currentColor_6%,transparent)] border border-(--color-card-glass-border,rgba(0,0,0,0.1)) rounded-full py-1 px-3"
        >
    ...
    <template v-else>
      ...
      <div v-if="aiUsage" class="grid grid-cols-1 gap-4 w-full mb-4">
        <div
          class="bg-card-glass-bg border border-card-glass-border rounded-default p-4 shadow-none transition-shadow duration-200 hover:shadow-[0_1px_3px_rgba(0,0,0,0.1)] dark:bg-surface-base dark:border-border-default"
        >
          <div
            class="min-h-full rounded-default transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] text-center flex flex-col justify-between"
          >
            <div class="flex flex-col justify-between">
              <div class="flex justify-between items-center">
                <div class="text-base font-medium leading-5 text-text-heading text-left">
                  {{ t("billing.aiCredits") }}
                </div>
