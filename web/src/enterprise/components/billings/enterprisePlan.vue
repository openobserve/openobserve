...
<template>
  <OCard class="flex flex-col shadow-none border border-card-glass-border bg-card-glass-bg rounded-lg w-full h-full dark:bg-surface-base dark:border-border-default">
    ...
    <div class="px-3 pt-2 h-[550px]">
      ...
      <p class="mb-3 mt-1 text-[0.8125rem] font-normal leading-[1.125rem] text-text-secondary m-0">
        {{ t("billing.included") }}
      </p>
    ...
    <p class="px-3 pt-2 text-[0.8125rem] font-normal leading-[1.125rem] text-text-secondary m-0">
