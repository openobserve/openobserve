  ...
  <OCard class="flex flex-col shadow-none border border-(--color-card-glass-border) bg-(--color-card-glass-bg) rounded-lg w-full h-full dark:bg-(--color-surface-base) dark:border-(--color-border-default)">
    <div class="flex items-center justify-between px-3 py-2">
      <div>
        ...
        <p class="mt-2 text-sm font-normal leading-[1.125rem] text-(--color-text-secondary) m-0">
    ...
    <div class="px-3 pt-2 h-[550px]">
      ...
      <p class="mb-3 mt-1 text-[0.8125rem] font-normal leading-[1.125rem] text-(--color-text-secondary) m-0">
        {{ t("billing.included") }}
      </p>
      ...
      >
        ...
        <span class="text-[0.938rem] leading-[1.375rem] text-(--color-text-body)"
      ...
      >
        <div class="flex items-center">
          ...
          />
          <div class="text-[0.938rem] leading-[1.375rem] text-(--color-text-body)" :class="{ 'ml-6': !feature.is_parent }">{{ feature.name }}</div>
        </div>
        <div class="text-[0.938rem] leading-[1.375rem] text-(--color-text-body) font-bold">{{ feature.price }}</div>
      </div>
    </div>

    <OSeparator />

    <p class="px-3 pt-2 text-[0.8125rem] font-normal leading-[1.125rem] text-(--color-text-secondary) m-0">
