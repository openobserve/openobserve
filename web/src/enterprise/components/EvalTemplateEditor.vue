      ...
      <div class="bg-card-glass-bg flex-1 min-h-0 mb-2 flex flex-col" style="padding: 1rem">
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 1rem">
          <div style="flex: 1; display: flex; flex-direction: column">
            <div class="flex items-center gap-1 mb-2">
              <label class="text-xs font-medium mb-0 text-text-primary leading-none">{{ t("evalTemplate.templateName") }} *</label>
          ...
          <div style="flex: 1; display: flex; flex-direction: column">
            <div class="flex items-center gap-1 mb-2">
              <label class="text-xs font-medium mb-0 text-text-primary leading-none">{{ t("common.description") }}</label>
              <OIcon name="info" size="xs" class="opacity-45 cursor-default shrink-0 hover:opacity-75">
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 1rem">
          <div style="flex: 0 0 200px; display: flex; flex-direction: column">
            <div class="flex items-center gap-1 mb-2">
              <label class="text-xs font-medium mb-0 text-text-primary leading-none">{{ t("evalTemplate.responseType") }} *</label>
              <OIcon name="info" size="xs" class="opacity-45 cursor-default shrink-0 hover:opacity-75">
          ...
          <div style="flex: 1; min-width: 0; display: flex; flex-direction: column; overflow: hidden">
            <div class="flex items-center gap-1 mb-2">
              <label class="text-xs font-medium mb-0 text-text-primary leading-none">{{ t("evalTemplate.dimensions") }} *</label>
              <OIcon name="info" size="xs" class="opacity-45 cursor-default shrink-0 hover:opacity-75">
        ...
        <div style="display: flex; flex-direction: column; flex: 1; min-height: 0">
          <div class="flex items-center gap-1 mb-2">
            <label class="text-xs font-medium mb-0 text-text-primary leading-none">{{ t("evalTemplate.promptTemplate") }} *</label>
            <OIcon name="info" size="xs" class="opacity-45 cursor-default shrink-0 hover:opacity-75">
