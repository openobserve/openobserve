  ...
  >
    <div class="scorer-type-panel w-[min(820px,calc(100vw-48px))] bg-card-bg border border-dialog-header-border rounded-lg shadow-(--shadow-lg,0_8px_24px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.08)) px-5.5 pt-5 pb-6">
      <header class="flex items-center gap-3 pb-3 border-b border-dialog-header-border mb-4">
        ...
        <button
          type="button"
          class="inline-flex items-center justify-center w-7 h-7 p-0 text-(--color-text-secondary,var(--color-text-secondary)) bg-transparent border-0 rounded-md cursor-pointer transition-[background,color] duration-150 hover:bg-[color-mix(in_srgb,var(--color-text-heading)_6%,transparent)] hover:text-(--color-primary-600,#3F7994)"
      ...
      <div class="grid grid-cols-3 max-[720px]:grid-cols-1 gap-3">
        <button
          type="button"
          class="relative flex flex-col items-start gap-2.5 min-h-45 py-4 px-4 pb-3.5 border border-(--color-dialog-header-border,var(--color-border-default)) rounded-lg bg-card-bg text-(--color-text-heading,currentColor) text-left cursor-pointer transition-[border-color,background,box-shadow] duration-[120ms] hover:border-(--color-primary-600,#3F7994) hover:bg-[color-mix(in_srgb,var(--color-primary-600)_4%,var(--color-card-bg))] hover:shadow-[0_0_0_3px_color-mix(in_srgb,var(--color-primary-600)_12%,transparent)]"
        ...
        <button
          type="button"
          class="relative flex flex-col items-start gap-2.5 min-h-45 py-4 px-4 pb-3.5 border border-(--color-dialog-header-border,var(--color-border-default)) rounded-lg bg-card-bg text-(--color-text-heading,currentColor) text-left cursor-not-allowed opacity-60 transition-[border-color,background,box-shadow] duration-[120ms]"
