<template>
  ...
  >
    <div
      class="scorer-type-panel w-[min(820px,calc(100vw-48px))] bg-card-bg border border-dialog-header-border rounded-default shadow-(--shadow-lg,0_8px_24px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.08)) px-5.5 pt-5 pb-6"
    >
      <header class="flex items-center gap-3 pb-3 border-b border-dialog-header-border mb-4">
        <h2 class="flex-1 m-0 text-base font-semibold text-text-heading">
          {{ t("onlineEvals.scorerTypeDialog.title") }}
        </h2>
        <button
          type="button"
      ...
      <p class="m-0 mb-4 text-text-secondary text-compact leading-normal">
      ...
      <div class="grid grid-cols-3 max-[720px]:grid-cols-1 gap-3">
        ...
        >
          <div
            class="inline-flex items-center justify-center w-9 h-9 rounded-default bg-[color-mix(in_srgb,var(--color-primary-600)_10%,transparent)] text-(--color-primary-600,#3F7994)"
          >
          ...
          <div
            class="flex-1 text-xs leading-normal text-(--color-text-secondary,var(--color-text-secondary))"
          >
            {{ t("onlineEvals.scorerTypeDialog.llmJudgeDescription") }}
          </div>
          <div
            class="inline-flex items-center gap-1 mt-auto text-xs font-semibold text-(--color-primary-600,#3F7994)"
          >
        ...
        >
          <span
            class="absolute top-3 right-3 py-0.5 px-2 rounded-default text-2xs font-semibold leading-normal bg-[color-mix(in_srgb,var(--color-status-warning-text)_14%,transparent)] text-status-warning-text"
          >
          ...
          <div
            class="inline-flex items-center gap-1 mt-auto text-xs font-semibold text-(--color-text-secondary,var(--color-text-secondary))"
          >
