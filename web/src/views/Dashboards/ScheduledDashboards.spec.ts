...
describe("ScheduledDashboards", () => {
  const defaultProps = {
    ...
    tabId: "test-tab",
    tabs: [{ tabId: "test-tab", name: "Test Tab" }],
  };
  ...
  describe("Component Initialization", () => {
    ...
    it("should apply dark-mode class when theme is dark", () => {
      ...
      const wrapper = createWrapper();
      expect(wrapper.find(".scheduled-dashboards").classes()).toContain(
        "dark-mode",
      );
    });
    ...
    const mockReports = [
      {
        name: "Cached Report",
        dashboards: [
          { tabs: ["test-tab"], timerange: { type: "relative", period: "1d" } },
        ],
        frequency: { type: "once" },
        created_at: 1640908800,
        org_id: "test-org",
      ...
      const simpleReports = [
        {
          ...
          dashboards: [
            {
              tabs: ["test-tab"],
              timerange: { type: "relative", period: "1d" },
            },
          ],
          frequency: { type: "once" },
          created_at: 1640908800,
  ...
  describe("Navigation and Actions", () => {
    it("should render new report button", () => {
      ...
      const hasNewReportButton = buttons.some(
        (btn) =>
