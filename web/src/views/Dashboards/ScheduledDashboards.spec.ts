      ...
      global: {
        ...
        stubs: {
          ...
          OInput: {
            name: "OInput",
            template:
              "<input class=\"o-input-mock\" :data-test=\"$attrs['data-test'] || 'o-input-mock'\" />",
          ...
          OButton: {
            name: "OButton",
            template:
              "<button class=\"o-btn-mock\" :data-test=\"$attrs['data-test'] || 'o-btn-mock'\" @click=\"$emit('click')\"><slot /></button>",
