<template>
  <div class="tw:rounded-md tw:p-0" data-test="iam-page">
    <OSplitter
    ...
    >
      <template v-slot:before>
        <div class="tw:w-full tw:h-full tw:pl-[0.625rem] tw:pt-1">
      ...
      <template v-slot:after>
        <div class="tw:w-full tw:h-full tw:pr-[0.625rem] tw:pt-1">
