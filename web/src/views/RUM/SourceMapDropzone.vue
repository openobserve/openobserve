    ...
    <template #default="{ field }">
      <div>
        <div
          ...
          class="border-2 border-dashed border-card-glass-border rounded-lg p-8 text-center cursor-pointer transition-all duration-300 bg-surface-base hover:border-theme-accent dark:border-[rgba(255,255,255,0.1)] dark:hover:bg-[color-mix(in_srgb,var(--color-theme-accent)_5%,transparent)]"
          :class="[
