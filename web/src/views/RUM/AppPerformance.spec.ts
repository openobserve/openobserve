...
describe("AppPerformance.vue", () => {
      ...
      global: {
        ...
        stubs: {
          ...
          DateTimePickerDashboard: {
            template:
              '<div data-test="date-time-picker" ref="dateTimePicker"></div>',
            props: ["modelValue"],
  ...
  describe("Component Rendering", () => {
    it("should render the component with correct structure", () => {
      ...
      expect(wrapper.find('[data-test="date-time-picker"]').exists()).toBe(
        true,
      );
      expect(wrapper.find('[data-test="auto-refresh-interval"]').exists()).toBe(
        true,
      );
    ...
    it("should have correct key attribute based on organization", () => {
      ...
      expect(
        componentInstance.store.state.selectedOrganization.identifier,
      ).toBe("test-org-123");
