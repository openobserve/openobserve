        ...
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            ...
            <div class="mt-1 flex flex-wrap items-center gap-2">
              <img
                ...
                class="max-h-9 max-w-37.5 shrink-0 object-contain"
              />
              <h1 class="text-text-heading text-xl font-semibold">{{ headingName }}</h1>
            </div>
          ...
          <div class="text-text-secondary text-2xs flex shrink-0 items-center gap-1.5">
            ...
            <a
              ...
              class="flex items-center gap-1.5 hover:underline focus-visible:underline"
            >
              <svg
