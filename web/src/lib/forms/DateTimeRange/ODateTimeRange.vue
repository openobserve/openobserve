        ...
        >
          ...
          >
            ...
            <div class="flex gap-1 flex-wrap">
              <button
                ...
                :class="[
                  'w-8 h-7 rounded-sm text-xs transition-[color,background-color,border-color,box-shadow] duration-150 outline-none ring-offset-1 ring-offset-surface-base focus-visible:ring-2 focus-visible:ring-datepicker-focus-ring tabular-nums',
          ...
          >
            ...
            <input
              ...
              min="1"
              :disabled="disabled"
              class="w-16 h-7 rounded-sm border border-datepicker-border bg-datepicker-bg text-datepicker-text text-xs px-2 outline-none focus:border-datepicker-focus-border tabular-nums disabled:opacity-50"
            ...
            <select
              v-model="customUnit"
              :disabled="disabled"
              class="flex-1 h-7 rounded-sm border border-datepicker-border bg-datepicker-bg text-datepicker-text text-xs px-2 outline-none focus:border-datepicker-focus-border disabled:opacity-50"
          ...
          >
            ...
            <button
              type="button"
              :disabled="disabled"
              class="flex items-center justify-between w-full h-7 rounded-sm border border-datepicker-inner-border bg-datepicker-bg text-datepicker-text text-xs px-2 outline-none disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div
              ...
              class="rounded-sm border border-datepicker-inner-border overflow-hidden"
            >
              <input
                v-model="tzSearch"
                type="text"
          ...
          >
            <button
              ...
              class="px-4 py-1.5 rounded-sm text-sm font-medium transition-[color,background-color,border-color,box-shadow] duration-150 outline-none ring-offset-1 ring-offset-surface-base bg-datepicker-day-selected-bg text-datepicker-day-selected-text hover:opacity-90 focus-visible:ring-2 focus-visible:ring-datepicker-focus-ring disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        >
          ...
          >
            <template #default="{ weekDays, grid }">
              ...
              >
                <RangeCalendarPrev
                  class="flex items-center justify-center size-7 rounded-sm transition-[color,background-color,border-color,box-shadow] duration-150 outline-none ring-offset-1 ring-offset-surface-base text-datepicker-icon hover:bg-datepicker-nav-hover-bg focus-visible:ring-2 focus-visible:ring-datepicker-focus-ring"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
