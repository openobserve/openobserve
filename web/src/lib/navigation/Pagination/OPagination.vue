...
<template>
  ...
  >
    ...
    <button
      type="button"
      class="o-pagination__btn flex size-7 items-center justify-center rounded-sm transition-colors"
      :class="[
        isFirst || disable
    ...
    <button
      ...
      :key="page"
      type="button"
      class="o-pagination__btn flex size-7 items-center justify-center rounded-sm text-sm font-medium transition-colors"
      :class="[
        page === modelValue
