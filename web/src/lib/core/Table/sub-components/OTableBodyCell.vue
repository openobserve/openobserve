...
<template>
  ...
  >
    ...
    >
      ...
      >
        <button
          ...
          type="button"
          class="inline-flex items-center justify-center w-4.5 h-4.5 p-0 bg-transparent border-0 rounded-sm cursor-pointer text-text-secondary hover:bg-table-row-hover-bg hover:text-text-body"
    ...
    <button
      ...
      class="absolute right-1 opacity-0 group-hover:opacity-100 bg-surface-base border border-border-default rounded-sm cursor-pointer p-0.5 text-text-muted hover:text-text-body leading-none transition-opacity"
