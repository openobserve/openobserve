...
<template>
  <nav
    ...
    data-o2-navbar
    class="left-drawer o2-navbar-scroll dark:[--color-tabs-inactive-text:var(--color-text-secondary)] flex flex-col bg-surface-chrome-deeper shrink-0 min-h-0 overflow-y-auto w-[5.5rem] pb-1"
