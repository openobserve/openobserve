...
<template>
  ...
  >
    ...
    <circle cx="120" cy="96" r="2.4" fill="var(--color-warning-500)">
      <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 36" keyTimes="0;1" dur="1.5s" repeatCount="indefinite" />
      <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.5s" repeatCount="indefinite" />
    </circle>
    <circle cx="120" cy="96" r="2" fill="var(--color-warning-500)">
      <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 36" keyTimes="0;1" dur="1.5s" repeatCount="indefinite" begin="-0.5s" />
      <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.5s" repeatCount="indefinite" begin="-0.5s" />
    </circle>
    <circle cx="120" cy="96" r="2.4" fill="var(--color-warning-600)">
      <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 36" keyTimes="0;1" dur="1.5s" repeatCount="indefinite" begin="-1s" />
      <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.5s" repeatCount="indefinite" begin="-1s" />
    </circle>
  </svg>
</template>
