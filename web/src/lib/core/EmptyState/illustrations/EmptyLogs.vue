...
<template>
  <svg
    ...
    role="img"
    :aria-label="t('emptyState.illustrations.noLogsFound')"
  ...
  >
    ...
    <g>
      <circle cx="58" cy="70" r="3" fill="var(--color-primary-400)" />
      <rect
        x="70"
        y="67"
        width="108"
        ...
        opacity="0.45"
      />
      <circle cx="58" cy="86" r="3" fill="var(--color-warning-500)" />
      <rect
        x="70"
        y="83"
        width="86"
        ...
        opacity="0.4"
      />
      <circle cx="58" cy="103" r="3" fill="var(--color-error-500)" />
      <rect
        x="70"
        y="100"
        width="116"
        ...
        opacity="0.5"
      />
      <circle cx="58" cy="120" r="3" fill="var(--color-primary-400)" />
      <rect
        x="70"
        y="117"
        width="74"
        ...
        opacity="0.4"
      />
      <circle cx="58" cy="136" r="3" fill="var(--color-success-500)" />
      <rect
        x="70"
        y="133"
        width="96"
