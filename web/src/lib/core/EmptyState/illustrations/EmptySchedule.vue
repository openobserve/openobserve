...
<template>
  ...
  >
    ...
    <g fill="var(--color-border-default)" opacity="0.5">
      <circle cx="30" cy="50" r="2" /><circle cx="214" cy="118" r="2" /><circle cx="210" cy="44" r="1.6" />
    </g>
    ...
    <rect x="42" y="46" width="156" height="92" rx="10" fill="var(--color-surface-base)" stroke="var(--color-border-strong)" stroke-width="2.5" />

    <!-- queued job rows (status dot + bar) -->
    <g>
      <circle cx="60" cy="68" r="4.5" fill="var(--color-primary-500)">
        <animate v-if="animated" attributeName="opacity" values="0.35;1;0.35" keyTimes="0;0.5;1" dur="3s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
      </circle>
      <rect x="74" y="63.5" width="94" height="8" rx="4" fill="var(--color-border-default)" />
    </g>
    <g>
      <circle cx="60" cy="92" r="4.5" fill="var(--color-primary-500)">
        <animate v-if="animated" attributeName="opacity" values="0.35;1;0.35" keyTimes="0;0.5;1" dur="3s" repeatCount="indefinite" begin="0.6s" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
      </circle>
    ...
    <g>
      <circle cx="60" cy="116" r="4.5" fill="var(--color-primary-500)">
        <animate v-if="animated" attributeName="opacity" values="0.35;1;0.35" keyTimes="0;0.5;1" dur="3s" repeatCount="indefinite" begin="1.2s" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
      </circle>
    ...
    <line x1="182" y1="128" x2="192" y2="128" stroke="var(--color-primary-600)" stroke-width="2.25" stroke-linecap="round">
      <animateTransform v-if="animated" attributeName="transform" type="rotate" values="0 182 128; 360 182 128" keyTimes="0;1" dur="6s" repeatCount="indefinite" />
    </line>
