...
<template>
  ...
  >
    ...
    <!-- drifting + confetti -->
    <g class="es-cf es-cf-a" transform="translate(196 40)" stroke="var(--color-primary-400)" stroke-width="3" stroke-linecap="round">
      <line x1="-5" y1="0" x2="5" y2="0" /><line x1="0" y1="-5" x2="0" y2="5" />
    </g>
    <g class="es-cf es-cf-b" transform="translate(40 56)" stroke="var(--color-primary-300)" stroke-width="3" stroke-linecap="round">
    ...
    <g class="es-spark" transform="translate(190 92)">
