...
<template>
  <svg
    ...
    role="img"
    :aria-label="t('emptyState.noPipelines.title')"
  >
    ...
    />
    <path
      d="M54 76 Q54 70 60 70 Q66 70 66 76 M54 70 Q54 66 60 66 Q66 66 66 70"
    ...
    />
    <path
      d="M114 64 l-6 6 6 6 M126 64 l6 6 -6 6"
      stroke="var(--color-primary-500)"
      stroke-width="2"
      fill="none"
    ...
    <rect
      ...
      stroke-width="2"
    />
    <rect x="48" y="110" width="4" height="6" rx="1.5" fill="var(--color-primary-400)" />
    <rect x="55" y="106" width="4" height="10" rx="1.5" fill="var(--color-primary-500)" />
    <rect x="62" y="108" width="4" height="8" rx="1.5" fill="var(--color-primary-600)" />
