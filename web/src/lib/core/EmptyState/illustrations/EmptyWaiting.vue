...
<template>
  ...
  >
    ...
    <g>
      ...
      <!-- falling grains -->
      <circle class="es-grain es-grain-a [transform-box:view-box] origin-center [animation:es-grain_1.6s_linear_infinite]" cx="138" cy="138" r="2.4" fill="var(--color-warning-500)" />
      <circle class="es-grain es-grain-b [transform-box:view-box] origin-center [animation:es-grain_1.6s_linear_infinite] [animation-delay:-0.55s]" cx="138" cy="138" r="2" fill="var(--color-warning-500)" />
      <circle class="es-grain es-grain-c [transform-box:view-box] origin-center [animation:es-grain_1.6s_linear_infinite] [animation-delay:-1.1s]" cx="138" cy="138" r="2.4" fill="var(--color-warning-600)" />
    </g>
