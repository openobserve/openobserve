  ...
  >
    ...
    <g>
      ...
      <circle cx="138" cy="138" r="2.4" fill="var(--color-warning-500)">
        <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 46" keyTimes="0;1" dur="1.6s" repeatCount="indefinite" />
        <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.6s" repeatCount="indefinite" />
      </circle>
      <circle cx="138" cy="138" r="2" fill="var(--color-warning-500)">
        <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 46" keyTimes="0;1" dur="1.6s" repeatCount="indefinite" begin="-0.55s" />
        <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.6s" repeatCount="indefinite" begin="-0.55s" />
      </circle>
      <circle cx="138" cy="138" r="2.4" fill="var(--color-warning-600)">
        <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 46" keyTimes="0;1" dur="1.6s" repeatCount="indefinite" begin="-1.1s" />
        <animate v-if="animated" attributeName="opacity" values="0;1;1;0" keyTimes="0;0.2;0.85;1" dur="1.6s" repeatCount="indefinite" begin="-1.1s" />
      </circle>
    </g>
    ...
    <g>
      <animateTransform v-if="animated" attributeName="transform" type="translate" values="0 0; 0 -2; 0 0" keyTimes="0;0.5;1" dur="4s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
      <!-- folded legs / lap -->
      ...
      <g>
        <animateTransform v-if="animated" attributeName="transform" type="rotate" values="-1.5 250 206; 2 250 206; -1.5 250 206" keyTimes="0;0.5;1" dur="5s" repeatCount="indefinite" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" />
