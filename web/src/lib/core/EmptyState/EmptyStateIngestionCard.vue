...
<template>
  <button
    type="button"
    class="es-ing-card relative flex items-center gap-3 w-[18rem] max-w-full min-h-16 py-2.5 pr-3.5 pl-3 rounded-xl border border-border-default bg-surface-base shadow-sm text-left cursor-pointer outline-none transition-[color,background-color,border-color,box-shadow] duration-150"
    @click="emit('click')"
  >
