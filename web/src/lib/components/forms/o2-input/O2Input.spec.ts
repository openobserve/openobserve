...
describe("O2Input", () => {
  ...
  describe("initial render", () => {
    ...
    it("should set placeholder on native input", () => {
      ...
      expect(wrapper.find(".o2-input__native").attributes("placeholder")).toBe(
        "Enter value",
      );
    });
    ...
    it("should reflect the initial modelValue in native input", () => {
      ...
      expect(
        (wrapper.find(".o2-input__native").element as HTMLInputElement).value,
      ).toBe("hello");
    });
  ...
  describe("validation", () => {
    const required = (val: unknown) =>
      (!!val && String(val).trim().length > 0) || "Required";
    ...
    it("should show error after validate() is called with invalid value", async () => {
      ...
      expect(wrapper.find(".o2-input__error-text").text()).toContain(
        "Required",
      );
    });
  ...
  describe("hint", () => {
    it("should render hint text from prop", () => {
      ...
      expect(wrapper.find(".o2-input__hint-text").text()).toBe(
    ...
    it("should render hint from slot", () => {
      ...
      expect(wrapper.find(".o2-input__hint-text").text()).toContain(
        "Slot hint text",
      );
    });
  ...
  describe("clearable", () => {
    ...
    it("clear button should have aria-label", () => {
      wrapper = mountInput({ modelValue: "hello", clearable: true });
      expect(wrapper.find(".o2-input__clear").attributes("aria-label")).toBe(
        "Clear",
      );
    });
  });
  ...
  describe("disabled state", () => {
    ...
    it("should set disabled attribute on native input", () => {
      wrapper = mountInput({ disabled: true });
      expect(
        wrapper.find(".o2-input__native").attributes("disabled"),
      ).toBeDefined();
    });
    ...
    it("should set readonly attribute on native input", () => {
      ...
      expect(
        wrapper.find(".o2-input__native").attributes("readonly"),
      ).toBeDefined();
    });
  });
  ...
  describe("loading", () => {
    ...
    it("spinner should have aria-hidden", () => {
      wrapper = mountInput({ loading: true });
      expect(wrapper.find(".o2-input__spinner").attributes("aria-hidden")).toBe(
        "true",
      );
    });
  });
  ...
  describe("slots", () => {
    ...
    it("should render append slot", () => {
      wrapper = mountInput(
        {},
        { append: '<span data-test="append-icon">⌕</span>' },
      );
  ...
  describe("maxlength", () => {
    it("should set maxlength attribute on native input", () => {
      ...
      expect(wrapper.find(".o2-input__native").attributes("maxlength")).toBe(
        "100",
      );
    });
  });
  ...
  describe("tabindex", () => {
    it("should set tabindex on native input", () => {
      ...
      expect(wrapper.find(".o2-input__native").attributes("tabindex")).toBe(
        "3",
      );
    });
  });
