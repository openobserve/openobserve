    ...
    const getOrganizationSettings = async () => {
      ...
      try {
        ...
        store.dispatch("setOrganizationSettings", {
          ...
          ai: {
            enabled: orgSettings?.data?.data?.ai?.enabled ?? false,
            assistant_enabled: orgSettings?.data?.data?.ai?.assistant_enabled ?? false,
            sre_enabled: orgSettings?.data?.data?.ai?.sre_enabled ?? false,
            evaluation_enabled: orgSettings?.data?.data?.ai?.evaluation_enabled ?? false,
          },
        });
