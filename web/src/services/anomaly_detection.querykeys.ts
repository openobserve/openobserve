...
export const anomalyKeys = {
  all: (org: string) => orgKey(org, "anomalyDetection"),
  list: (org: string) => orgKey(org, "anomalyDetection", "list"),
  history: (org: string, limit: number) => orgKey(org, "anomalyDetection", "history", limit),
};
