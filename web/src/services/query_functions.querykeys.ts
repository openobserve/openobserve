 ...
 */
export const queryFunctionKeys = {
  // The functions root, matching the previous scope: the VRL catalogue is
  // dropped alongside the user's own functions.
  all: (org: string) => orgKey(org, "functions"),
  catalogue: (org: string) => orgKey(org, "functions", "queryFunctions"),
};
