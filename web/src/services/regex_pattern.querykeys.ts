 ...
 */
export const regexPatternKeys = {
  all: (org: string) => orgKey(org, "settings", "regexPatterns"),
  list: (org: string) => orgKey(org, "settings", "regexPatterns"),
  builtInAll: (org: string) => orgKey(org, "settings", "builtInRegexPatterns"),
  builtIn: (org: string) => orgKey(org, "settings", "builtInRegexPatterns"),
};
