...
const { mockLoad, mockReady, mockIdentify, mockTrack, mockPage, mockReset, MockRudderAnalytics } =
  vi.hoisted(() => {
...
describe("segment_analytics service", () => {
  ...
  describe("module export", () => {
    it("exports a rudderanalytics instance as default", async () => {
      const { default: rudderanalytics } = await import("@/services/segment_analytics");
