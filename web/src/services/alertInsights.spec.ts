...
describe("alertInsights service", () => {
  ...
  describe("getSummary", () => {
    it("calls GET /api/{org}/alerts/insights/summary", () => {
      ...
      expect(mockHttpInstance.get).toHaveBeenCalledWith(`/api/${ORG}/alerts/insights/summary`, {
        params,
      });
    });
    ...
    it("propagates rejection from http().get", async () => {
      ...
      await expect(alertInsights.getSummary(ORG, {})).rejects.toThrow("network error");
    });
  });
  ...
  describe("getTimeseries", () => {
    it("calls GET /api/{org}/alerts/insights/timeseries", () => {
      ...
      expect(mockHttpInstance.get).toHaveBeenCalledWith(`/api/${ORG}/alerts/insights/timeseries`, {
        params,
      });
    });
    ...
    it("propagates rejection from http().get", async () => {
      ...
      await expect(alertInsights.getTimeseries(ORG, {})).rejects.toThrow("timeout");
    });
  });
  ...
  describe("getFrequency", () => {
    it("calls GET /api/{org}/alerts/insights/frequency", () => {
      ...
      expect(mockHttpInstance.get).toHaveBeenCalledWith(`/api/${ORG}/alerts/insights/frequency`, {
        params,
      });
    });
    ...
    it("propagates rejection from http().get", async () => {
      ...
      await expect(alertInsights.getFrequency(ORG, {})).rejects.toThrow("forbidden");
    });
  });
  ...
  describe("getCorrelation", () => {
    it("calls GET /api/{org}/alerts/insights/correlation", () => {
      ...
      expect(mockHttpInstance.get).toHaveBeenCalledWith(`/api/${ORG}/alerts/insights/correlation`, {
        params,
      });
    });
    ...
    it("propagates rejection from http().get", async () => {
      ...
      await expect(alertInsights.getCorrelation(ORG, {})).rejects.toThrow("server error");
    });
  });
  ...
  describe("getQuality", () => {
    it("calls GET /api/{org}/alerts/insights/quality", () => {
      ...
      expect(mockHttpInstance.get).toHaveBeenCalledWith(`/api/${ORG}/alerts/insights/quality`, {
        params,
      });
    });
    ...
    it("propagates rejection from http().get", async () => {
      ...
      await expect(alertInsights.getQuality(ORG, {})).rejects.toThrow("not found");
    });
  });
  ...
  describe("getAllInsights", () => {
    ...
    it("rejects with the first error when any sub-request fails", async () => {
      ...
      await expect(alertInsights.getAllInsights(ORG, {})).rejects.toThrow("timeseries failed");
    });
  });
});
