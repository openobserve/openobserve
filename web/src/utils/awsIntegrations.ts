...
export const awsIntegrations: AWSIntegration[] = [
  {
    ...
    icon: "",
    description:
      "Monitor AWS account activity and API usage across your infrastructure",
  ...
  },
  {
    ...
    icon: "",
    description:
      "Monitor ALB access logs for request patterns, errors, and latency",
    cloudFormationTemplate:
  ...
  },
  {
    ...
    hasDashboard: false,
    documentationUrl:
      "https://openobserve.ai/blog/how-to-monitor-all-aws-metrics-in-one-place/",
    category: "metrics",
    comingSoon: false,
  },
  {
    ...
    cloudFormationTemplates: [
      {
        ...
        description:
          "Deploy CloudWatch agent to EC2 instances via AWS Systems Manager",
      ...
      },
      {
        ...
        description:
          "Deploy OpenTelemetry collector to EC2 instances via AWS Systems Manager",
    ...
    componentOptions: [
      {
        ...
        description:
          "Manually install OpenObserve collector on Windows EC2 instances",
        component: "WindowsConfig",
      },
      {
        name: "Linux/Unix/MacOS (Manual Install)",
        description:
          "Manually install OpenObserve collector on Linux/Unix/MacOS EC2 instances",
  ...
  },
  {
    ...
    hasDashboard: true,
    dashboardGithubUrl:
      "https://raw.githubusercontent.com/openobserve/dashboards/main/AWS_Cloudwatch_RDS_Metrics/OpenObserve_RDS_Introspection.dashboard.json",
  ...
  },
  {
    ...
    hasDashboard: false,
    documentationUrl:
      "https://docs.aws.amazon.com/streams/latest/dev/using-other-services.html",
    category: "other",
    comingSoon: false,
  },
];
