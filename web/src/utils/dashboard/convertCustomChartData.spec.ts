...
import {
  runJavaScriptCode,
  panelIdToBeRefreshed,
} from "./convertCustomChartData";
...
describe("convertCustomChartData", () => {
  ...
  describe("Basic functionality", () => {
    ...
    it("should reject with validation error for unsafe code", async () => {
      ...
      await expect(
        runJavaScriptCode(panelSchema, searchQueryData),
      ).rejects.toThrow(
  ...
  describe("Successful execution flow", () => {
    it("should create iframe and execute valid code successfully", async () => {
      ...
      expect(mockIframe.srcdoc).toContain(
        "/src/assets/dashboard/echarts.min.js",
      );
      expect(mockIframe.srcdoc).toContain(
        "/src/assets/dashboard/purify.min.js",
      );
    ...
    it("should use /web/ prefix for assets when pathname contains 'web'", async () => {
      ...
      expect(mockIframe.srcdoc).toContain(
        "/web/src/assets/dashboard/echarts.min.js",
      );
      expect(mockIframe.srcdoc).toContain(
        "/web/src/assets/dashboard/purify.min.js",
      );
    });
