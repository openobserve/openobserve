...
describe("createTreeVisualizationEngine tooltip system", () => {
  ...
  it("should show tooltip when node is hovered", () => {
    ...
    const mouseMoveHandler = mockChart.on.mock.calls.find((call) => call[0] === "mouseover")[1];
  ...
  it("should hide tooltip on mouse leave", () => {
    ...
    const mouseLeaveHandler = mockChart.on.mock.calls.find((call) => call[0] === "globalout")[1];
