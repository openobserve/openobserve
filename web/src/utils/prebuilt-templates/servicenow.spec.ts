  ...
  describe("servicenowConfig", () => {
    ...
    it("validates instanceUrl credential field", () => {
      ...
      if (instanceField?.validator) {
        // Valid URLs
        expect(instanceField.validator("https://dev.service-now.com/api/now/table/incident")).toBe(
          true,
        );
        expect(
          instanceField.validator("https://company.service-now.com/api/now/table/incident"),
        ).toBe(true);
