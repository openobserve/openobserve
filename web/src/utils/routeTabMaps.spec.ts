...
describe("resolveTab", () => {
  ...
  describe("returns the mapped tab value when section and route are known", () => {
    ...
    it("ingestMetrics – categraf", () => {
      expect(resolveTab("ingestMetrics", "categraf", "prometheus")).toBe("categraf");
    });
...
describe("ROUTE_TAB_MAPS", () => {
  ...
  describe("section-level spot checks", () => {
    ...
    it("recommended has 11 entries", () => {
      expect(Object.keys(ROUTE_TAB_MAPS.recommended)).toHaveLength(11);
    });
    ...
    it("ingestMetrics has 7 entries", () => {
