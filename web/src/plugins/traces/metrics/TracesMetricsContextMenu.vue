...
<template>
  <div
    v-if="visible"
    ref="menuRef"
    class="fixed z-[9999] bg-dropdown-bg border border-solid border-dropdown-border rounded-sm shadow-[0_2px_8px_rgba(0,0,0,0.15)] min-w-50 py-1 dark:shadow-[0_2px_8px_rgba(0,0,0,0.4)]"
    :style="menuStyle"
    @click.stop
