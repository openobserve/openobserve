...
<template>
  ...
  >
    ...
    <div v-if="props.showSummary" class="thread-summary flex flex-wrap items-center gap-[0.4rem] py-2 px-4 bg-(--o2-bg-2,transparent) border-b border-(--o2-border-color)">
      ...
      <OBadge size="sm" class="thread-chip thread-chip--tools h-[26px]! px-[0.625rem]! py-0! bg-(--o2-card-bg)! border border-(--o2-border-color) rounded! text-xs! text-(--o2-text-primary)! border-l-[3px]! border-l-[#0ea5e9]!">
      ...
      <OBadge size="sm" class="thread-chip thread-chip--duration h-[26px]! px-[0.625rem]! py-0! bg-(--o2-card-bg)! border border-(--o2-border-color) rounded! text-xs! text-(--o2-text-primary)! border-l-[3px]! border-l-[#64748b]!">
      ...
      <OBadge size="sm" class="thread-chip thread-chip--cost h-[26px]! px-[0.625rem]! py-0! bg-(--o2-card-bg)! border border-(--o2-border-color) rounded! text-xs! text-(--o2-text-primary)! border-l-[3px]! border-l-[#16a34a]!">
