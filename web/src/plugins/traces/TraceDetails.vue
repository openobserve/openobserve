          ...
          <div class="box-border flex min-h-0 flex-1 flex-col overflow-hidden">
            ...
            <div v-if="activeTab === 'waterfall'" class="bg-card-glass-bg! flex h-full">
              ...
              <div
                ...
                class="border-s-card-glass-border min-h-0 shrink-0 overflow-x-hidden overflow-y-auto border-s border-solid transition-all duration-300"
            ...
            >
              ...
              <div
                v-if="isSidebarOpen && (selectedSpanId || showTraceDetails)"
                class="border-s-card-glass-border h-full overflow-hidden border-s border-solid"
