    ...
    <div class="flex items-center py-[0.625rem]">
      ...
      >
        <template v-if="statusCounts.critical > 0">
          <div
            class="inline-flex items-center gap-[0.375rem] px-[0.625rem] py-[0.25rem] rounded text-[0.75rem] font-medium bg-[color-mix(in_srgb,var(--color-service-health-critical)_12%,transparent)] text-service-health-critical"
        ...
        <template v-if="statusCounts.warning > 0">
          <div
            class="inline-flex items-center gap-[0.375rem] px-[0.625rem] py-[0.25rem] rounded text-[0.75rem] font-medium bg-[color-mix(in_srgb,var(--color-service-health-warning)_12%,transparent)] text-service-health-warning"
        ...
        <template v-if="statusCounts.degraded > 0">
          <div
            class="inline-flex items-center gap-[0.375rem] px-[0.625rem] py-[0.25rem] rounded text-[0.75rem] font-medium bg-[color-mix(in_srgb,var(--color-service-health-degraded)_12%,transparent)] text-service-health-degraded"
      ...
      <!-- Status legend -->
      <!-- <div
        class="ml-auto flex items-center gap-3 px-[0.625rem] py-[0.325rem] rounded border border-card-glass-border"
