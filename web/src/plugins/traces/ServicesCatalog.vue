      ...
      >
        <template v-if="statusCounts.critical > 0">
          ...
          >
            ...
            <OTooltip>
              <template #content>
                {{ t("traces.servicesCatalog.status.critical") }}: {{ t("traces.servicesCatalog.status.criticalThreshold") }}
        ...
        <template v-if="statusCounts.warning > 0">
          ...
          >
            ...
            <OTooltip>
              <template #content>
                {{ t("traces.servicesCatalog.status.warning") }}: {{ t("traces.servicesCatalog.status.warningThreshold") }}
                {{ t("traces.servicesCatalog.legend.title").toLowerCase() }}
              </template>
            </OTooltip>
          </div>
        ...
        <template v-if="statusCounts.degraded > 0">
          ...
          >
            ...
            <OTooltip>
              <template #content>
                {{ t("traces.servicesCatalog.status.degraded") }}: {{ t("traces.servicesCatalog.status.degradedThreshold") }}
                {{ t("traces.servicesCatalog.legend.title").toLowerCase() }}
              </template>
            </OTooltip>
          </div>
