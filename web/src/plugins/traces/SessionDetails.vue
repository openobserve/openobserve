        ...
        >
          ...
          >
            ...
            <template v-for="chip in card.subTurns" :key="chip.n">
              ...
              >
                <span
                  class="inline-flex items-center justify-center min-w-[1rem] h-[1.05rem] px-[0.3rem] rounded-[0.3rem] border border-border-default bg-surface-base text-text-heading text-[0.68rem] font-bold leading-none cursor-pointer transition-colors hover:bg-[color-mix(in_srgb,var(--color-text-heading)_8%,var(--color-surface-base))] hover:border-[color-mix(in_srgb,var(--color-text-heading)_25%,var(--color-border-default))]"
        ...
        >
          ...
          >
            ...
            <div
              ...
              class="border-t border-border-default bg-surface-base p-[0.75rem]"
              ...
              <div v-else class="flex flex-col gap-[0.625rem]">
                ...
                <div class="rounded-lg border border-border-default bg-surface-base overflow-hidden">
                  <div class="flex items-center justify-between px-[0.625rem] py-[0.375rem] border-b border-border-default">
                    <span class="text-[0.75rem] font-bold text-text-heading">
                ...
                <div class="rounded-lg border border-border-default bg-surface-base overflow-hidden">
                  <div class="flex items-center justify-between px-[0.625rem] py-[0.375rem] border-b border-border-default">
                    <span class="flex items-center gap-[0.375rem] text-[0.75rem] font-bold text-text-heading">
          ...
          >
            ...
            >
              ...
              <OTooltip side="left" :delay="120" max-width="220px" content-class="p-0!">
                <template #content>
                  <div class="w-[200px] py-[9px] px-3 text-xs text-text-heading">
                    ...
                    <div class="flex flex-wrap gap-1">
                      <span
                        ...
                        :key="tn"
                        class="inline-flex items-center px-[0.35rem] h-[1.05rem] rounded-[0.3rem] border border-border-default bg-surface-base text-[10px] font-semibold tabular-nums"
