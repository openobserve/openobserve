...
<template>
  ...
  <div
    ...
    class="source-event-banner flex items-start gap-3 px-4 py-2 border-b border-solid border-[var(--color-card-glass-border)]"
  >
    <OTag
  ...
  <div
    ...
    class="flex items-center gap-6 px-4 border-b border-solid border-[var(--color-card-glass-border)]"
  >
