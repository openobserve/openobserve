                  ...
                  >
                    ...
                    >
                      <template v-if="group.streams.length > 0">
                        <div
                          class="flex items-center justify-between py-1.5 px-2 bg-(--o2-section-header-bg) border-b border-solid border-(--color-border-default) sticky top-0 z-10 cursor-pointer"
    ...
    <div class="metric-list-container max-h-100 overflow-y-auto">
      ...
      >
        ...
        >
          ...
          <template v-if="group.streams.length > 0">
            <!-- Group header -->
            <div class="flex items-center justify-between py-1.5 px-2 bg-(--o2-section-header-bg) border-b border-solid border-(--color-border-default) sticky top-0 z-10">
              <div class="flex items-center gap-[0.375rem] text-[0.6875rem] font-bold uppercase tracking-[0.05em] opacity-75">
                <OIcon v-if="typeof group.icon === 'string'" :name="group.icon" size="xs" class="mr-0.5" />
                <component v-else :is="group.icon" />
                <span>{{ group.label }}</span>
