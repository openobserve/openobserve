...
<template>
  ...
  >
          ...
          <template v-slot:append>
            <div class="ai-horizontal-controls">
              ...
              <div class="ai-arrows-stack">
                ...
                <q-tooltip style="width: 120px">Collapse AI Assistant</q-tooltip>
              </div>
            </div>
          </template>
        </q-input>
    ...
    <div class="row query-editor-container ai-enhanced-container" :class="{ 'ai-focused': isAiFocused }">
      <div
        class="col editor-column"
        :style="{
          'border-top': '1px solid #dbdbdb',
          'height': isAiAssistantVisible ? `calc(100% - ${aiBarHeight}px)` : '',
      ...
      <q-btn
        ...
        style="position: absolute; top: 10px; right: 3px; z-index: 20;padding: 5px 5px;border-radius: 8px;"
      ></q-btn>
    </div>
