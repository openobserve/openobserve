...
<template>
  ...
  <q-list>
                ...
                <q-item
                  v-if="shouldMoveSavedViewToMenu"
                  clickable
                  @click="openSavedViewsList; close()"
  ...
  <q-list>
                ...
                <q-separator />
                <OMenu submenu anchor="top end" self="top start" :offset="[0, 0]">
                ...
                <q-item
                  ...
                  class="q-pa-sm saved-view-item"
                  clickable
                  @click="routeToSearchSchedule; close()"
                >
                  <q-item-section>
                    <q-item-label
                      class="tw:flex tw:items-center tw:gap-2"
                ...
                <q-item
                  ...
                  class="q-pa-sm saved-view-item"
                  clickable
                  @click="openSearchInspectDialog; close()"
                >
                  <q-item-section>
                    <q-item-label
                      class="tw:flex tw:items-center tw:gap-2"
