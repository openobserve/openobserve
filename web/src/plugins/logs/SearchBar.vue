...
<template>
  <div class="logs-search-bar-component" id="searchBarComponent">
        ...
        >
          ...
          <ODropdownGroup :label="t('search.menuGroupDownloads')">
            ...
            <div
              ...
              class="hover:bg-interactive-hover-bg search-download-item relative flex cursor-pointer items-center gap-2 px-3 py-1.5 [line-height:1.2] text-[var(--text-sm)] select-none before:absolute before:end-full before:top-0 before:h-full before:w-2.5 before:content-['']"
              :class="{
            ...
            >
              ...
              <div
                ...
                class="search-download-submenu bg-dropdown-bg rounded-default shadow-hover-shadow absolute end-full top-0 z-9999 me-1 min-w-40 px-0 py-1 shadow-lg [border:0.063rem_solid_var(--color-card-glass-border)]"
                data-test="search-download-submenu"
              >
                <button
                  type="button"
                  data-test="search-download-csv-btn"
                  class="text-text-body hover:bg-interactive-hover-bg flex w-full cursor-pointer items-center gap-2.5 border-0 bg-transparent px-3 py-1.5 text-start [line-height:1.2] text-[var(--text-sm)]"
                  @click="
    ...
    >
      ...
      <div class="mapping-warning-msg mt-3 text-start opacity-80">
    ...
    >
      <div class="mb-1 text-start">{{ t("search.traceIdLabel") }}</div>
      <OInput
...
/* The inline-start padding preserves the existing px-1 cascade result. */
