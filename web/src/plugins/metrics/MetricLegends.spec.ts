...
describe("MetricLegends", () => {
    ...
    return mount(MetricLegends, {
      global: {
        ...
        stubs: {
          "q-btn": {
            template:
              '<button class="q-btn" data-cy="metric-legends-button"><slot /></button>',
          },
          "q-icon": {
          ...
          "q-menu": {
            template:
              '<div class="q-menu" :class="$attrs.class"><slot /></div>',
          },
          "q-card": {
          ...
          "q-card-section": {
            template:
              '<div class="q-card-section" :class="$attrs.class"><slot /></div>',
          },
          "q-separator": {
  ...
  describe("Component Initialization", () => {
    it("should render component correctly", () => {
      ...
      expect(wrapper.find('[data-cy="metric-legends-button"]').exists()).toBe(
        true,
      );
    });
  ...
  describe("Legend Items Rendering", () => {
    ...
    it("should render Summary legend item", () => {
      const legendItems = wrapper.findAll(".legend-item");
      const summaryItem = legendItems.find((item) =>
    ...
    it("should render Gauge legend item", () => {
      const legendItems = wrapper.findAll(".legend-item");
      const gaugeItem = legendItems.find((item) =>
        item.text().includes("Gauge"),
      );
    ...
    it("should render Histogram legend item", () => {
      const legendItems = wrapper.findAll(".legend-item");
      const histogramItem = legendItems.find((item) =>
        item.text().includes("Histogram"),
      );
    ...
    it("should render Counter legend item", () => {
      const legendItems = wrapper.findAll(".legend-item");
      const counterItem = legendItems.find((item) =>
        item.text().includes("Counter"),
      );
  ...
  describe("Theme Integration", () => {
    ...
    it("should have theme-based class binding", () => {
      const menu = wrapper.find(".q-menu");
      const hasThemeClass = menu
        .classes()
        .some((cls) => cls === "theme-dark" || cls === "theme-light");
  ...
  describe("Vuex Store Integration", () => {
    ...
    it("should use store theme for conditional class application", () => {
      const themeClass =
        wrapper.vm.store.state.theme === "dark" ? "theme-dark" : "theme-light";
      const menu = wrapper.find(".q-menu");
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    it("should handle metricsIconMapping as immutable", () => {
      ...
      expect(wrapper.vm.metricsIconMapping.Summary).toBe(
        originalMapping.Summary,
      );
      expect(wrapper.vm.metricsIconMapping.Gauge).toBe(originalMapping.Gauge);
      expect(wrapper.vm.metricsIconMapping.Histogram).toBe(
        originalMapping.Histogram,
      );
      expect(wrapper.vm.metricsIconMapping.Counter).toBe(
        originalMapping.Counter,
      );
    });
