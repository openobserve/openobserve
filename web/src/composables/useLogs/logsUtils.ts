 ...
 * ```
 */
export const hasAggregation = (columns: SQLColumn[]): boolean => {
 ...
 */
export const addTraceId = (traceId: string): void => {
 ...
 */
export const removeTraceId = (traceId: string): void => {
  // Validate input parameter
  if (!traceId || typeof traceId !== "string") {
