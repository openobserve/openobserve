...
export type BrowserCheckGateForm = z.infer<
  ReturnType<typeof makeBrowserCheckGateSchema>
>;
...
export const makeBrowserCheckSaveSchema = (t: (_key: string) => string) =>
  z.object({
    ...
    locations: z
      .array(z.string())
      .min(1, t("synthetics.validation.locationsRequired")),
    journey: z
      .array(
        z.object({
          id: z.string(),
...
export type BrowserCheckSaveForm = z.infer<
  ReturnType<typeof makeBrowserCheckSaveSchema>
>;
