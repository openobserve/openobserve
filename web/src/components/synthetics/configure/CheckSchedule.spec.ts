...
describe('CheckSchedule', () => {
  ...
  describe('initial render', () => {
    ...
    it('should render frequency preset items', () => {
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-1min-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-5min-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-15min-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-30min-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-1hour-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-cron-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-frequency-custom-item"]').exists()).toBe(true)
    })
  ...
  describe('custom frequency', () => {
    it('should show custom interval inputs when preset is custom', () => {
      ...
      const valueInput = wrapper.find('[data-test="synthetics-check-schedule-custom-interval-value-input"]')
      expect(valueInput.exists()).toBe(true)

      const unitSelect = wrapper.find('[data-test="synthetics-check-schedule-custom-interval-unit-select"]')
    ...
    it('should emit update:check when custom interval value changes', async () => {
      ...
      const valueInput = wrapper.find('[data-test="synthetics-check-schedule-custom-interval-value-input"] input')
      expect(valueInput.exists()).toBe(true)
    ...
    it('should emit update:check when custom interval unit changes', async () => {
      ...
      const unitSelect = wrapper.find('[data-test="synthetics-check-schedule-custom-interval-unit-select"] select')
      expect(unitSelect.exists()).toBe(true)
  ...
  describe('start type', () => {
    it('should show start type toggle for interval schedules', () => {
      wrapper = mountSchedule()
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-now-item"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-later-item"]').exists()).toBe(true)
    })
    ...
    it('should show date and time inputs when startType is later', () => {
      ...
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-date-input"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-time-input"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-timezone-select"]').exists()).toBe(true)
    })
    ...
    it('should not show date and time inputs when startType is now', () => {
      ...
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-date-input"]').exists()).toBe(false)
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-time-input"]').exists()).toBe(false)
      expect(wrapper.find('[data-test="synthetics-check-schedule-start-timezone-select"]').exists()).toBe(false)
    })
    ...
    it('should emit update:check when start date changes', async () => {
      ...
      const dateInput = wrapper.find('[data-test="synthetics-check-schedule-start-date-input"] input')
    ...
    it('should emit update:check when start time changes', async () => {
      ...
      const timeInput = wrapper.find('[data-test="synthetics-check-schedule-start-time-input"] input')
    ...
    it('should emit update:check when timezone changes for later schedule', async () => {
      ...
      const tzSelect = wrapper.find('[data-test="synthetics-check-schedule-start-timezone-select"] select')
      expect(tzSelect.exists()).toBe(true)
  ...
  describe('timezone for cron schedule', () => {
    it('should emit update:check when timezone changes for cron schedule', async () => {
      ...
      const tzSelect = wrapper.find('[data-test="synthetics-check-schedule-timezone-select"] select')
      expect(tzSelect.exists()).toBe(true)
  ...
  describe('preset detection from schedule', () => {
    ...
    it('should treat non-standard interval as custom frequency', () => {
      ...
      expect(wrapper.find('[data-test="synthetics-check-schedule-custom-interval-value-input"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-schedule-custom-interval-unit-select"]').exists()).toBe(true)
    })
  })
})
