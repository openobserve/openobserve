...
describe('CheckHttpConfig', () => {
  ...
  describe('initial render', () => {
    ...
    it('should render follow redirects switch as checked', () => {
      const followSwitch = wrapper.find('[data-test="synthetics-check-http-follow-redirects-switch"]')
  ...
  describe('headers CRUD', () => {
    it('should add a new empty header row when add header button is clicked', async () => {
      ...
      expect(wrapper.find('[data-test="synthetics-check-http-header-name-1"]').exists()).toBe(false)
  ...
  describe('assertions CRUD', () => {
    it('should add a new default assertion when add assertion button is clicked', async () => {
      ...
      expect(wrapper.find('[data-test="synthetics-check-http-assertion-field-2"]').exists()).toBe(false)
      ...
      expect(lastEmit.http!.assertions[2]).toEqual({ field: 'status_code', operator: 'eq', value: '' })
    })
    ...
    it('should update assertion operator and emit update:check when operator select changes', async () => {
      const operatorSelect = wrapper.find('[data-test="synthetics-check-http-assertion-operator-0"]')
