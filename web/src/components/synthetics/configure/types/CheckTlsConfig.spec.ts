...
describe('CheckTlsConfig', () => {
  ...
  describe('initial render', () => {
    ...
    it('should render verify chain switch as checked', () => {
      const verifyChainSwitch = wrapper.find('[data-test="synthetics-check-tls-verify-chain-switch"]')
    ...
    it('should render verify hostname switch as checked', () => {
      const verifyHostnameSwitch = wrapper.find('[data-test="synthetics-check-tls-verify-hostname-switch"]')
