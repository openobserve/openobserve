...
describe('CheckLocations', () => {
  ...
  describe('initial render', () => {
    ...
    it('should render one checkbox per location', () => {
      expect(wrapper.find('[data-test="synthetics-check-locations-option-us-east-1"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-locations-option-eu-west-1"]').exists()).toBe(true)
      expect(wrapper.find('[data-test="synthetics-check-locations-option-ap-southeast-1"]').exists()).toBe(true)
    })
    ...
    it('should mark pre-selected locations as checked', () => {
      ...
      const usEastCheckbox = wrapper.find('[data-test="synthetics-check-locations-option-us-east-1"] input')
      const euWestCheckbox = wrapper.find('[data-test="synthetics-check-locations-option-eu-west-1"] input')
      const apSoutheastCheckbox = wrapper.find('[data-test="synthetics-check-locations-option-ap-southeast-1"] input')
  ...
  describe('location selection', () => {
    ...
    it('should emit update:check when a location is toggled on', async () => {
      ...
      const checkbox = wrapper.find('[data-test="synthetics-check-locations-option-ap-southeast-1"] input')
    ...
    it('should emit update:check when a location is toggled off', async () => {
      ...
      const checkbox = wrapper.find('[data-test="synthetics-check-locations-option-us-east-1"] input')
      await checkbox.trigger('click')
      await flushPromises()
