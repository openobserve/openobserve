      ...
      <template v-else>
        ...
        <div class="grid grid-cols-3 gap-x-6 px-5 py-4 border-b border-border-default bg-surface-panel shrink-0">
          <div>
            ...
            <p class="text-sm font-semibold text-text-primary">{{ fmtDuration(overallDurationMs) }}</p>
          </div>
          <div>
            <p class="text-3xs font-semibold uppercase tracking-[0.06em] text-text-muted mb-[0.2rem]">{{ t('synthetics.runDetail.locations') }}</p>
            <p class="text-sm font-semibold text-text-primary">{{ locations.length }}</p>
          </div>
          <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                  ...
                  >
                    <div class="flex items-center gap-1.5 px-2 py-1 border-b border-border-default">
                      ...
                      />
                      <span class="text-3xs font-mono text-text-muted truncate">{{ step.stepId }}</span>
                    </div>
