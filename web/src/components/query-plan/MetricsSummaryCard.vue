  ...
  >
    <OCardSection role="body">
      ...
      <div class="grid [grid-template-columns:repeat(auto-fit,minmax(11.25rem,1fr))] gap-4">
        <div data-test="metrics-summary-card-item" class="flex items-center gap-3 p-[0.875rem_1rem] rounded-lg bg-[var(--color-card-glass-bg)] border border-solid border-[var(--color-card-glass-border)] transition-[border-color,box-shadow] duration-200 hover:border-accent hover:shadow-[0_0.0625rem_0.1875rem_rgba(0,0,0,0.05)]">
