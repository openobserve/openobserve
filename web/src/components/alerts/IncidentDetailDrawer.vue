...
<template>
  <q-page
    data-test="incident-detail-page"
    class="q-pa-none"
  ...
  >
    <div class="tw:w-full tw:h-full tw:px-[0.625rem] q-mt-xs tw:pb-[0.625rem]">
      <!-- Header -->
      <div
        class="row items-center no-wrap card-container tw:py-[0.675rem] tw:h-[68px] tw:px-[0.675rem] tw:mb-[0.675rem]"
      >
        <div class="flex items-center tw:gap-3 tw:flex-1">
          ...
          >
            ...
            <q-tooltip
              v-if="incidentDetails && incidentDetails.title.length > 35"
              class="tw:text-sm"
            >
              {{ incidentDetails.title }}
            </q-tooltip>
        ...
        <div
          v-if="incidentDetails && !isEditingTitle"
          class="tw:flex tw:items-center tw:gap-2 tw:ml-auto"
        >
          <!-- Status Badge -->
          <q-badge
          ...
          <q-badge
            :style="{
              color: getSeverityColorHex(incidentDetails.severity),
              height: '33px',
            }"
            class="tw:px-2.5 tw:py-1.5 tw:cursor-default"
            outline
          ...
          >
            ...
            <q-tooltip :delay="200" class="tw:text-sm">
              ...
              {{ triggers.length }} correlated alerts
            </q-tooltip>
          </q-badge>
        </div>
        ...
        <div
          ...
          class="tw:flex tw:items-center tw:gap-2 tw:ml-auto"
        >
          <q-btn no-caps @click="cancelTitleEdit"
class="o2-secondary-button">
            <span>{{ t("alerts.cancel") }}</span>
          </q-btn>
          <q-btn no-caps @click="saveTitleEdit"
class="o2-primary-button">
        ...
        >
          ...
          >
            ...
            <q-tooltip :delay="500">{{
              t("alerts.incidents.markAsAcknowledgedTooltip")
            }}</q-tooltip>
          </q-btn>
          <q-btn
          ...
          >
            ...
            <q-tooltip :delay="500">{{
              t("alerts.incidents.markAsResolvedTooltip")
            }}</q-tooltip>
          </q-btn>
          <q-btn
            v-if="incidentDetails.status === 'resolved'"
...
size="16px" class="tw:mr-1" />
            ...
            <q-tooltip :delay="500">{{
              t("alerts.incidents.reopenIncidentTooltip")
            }}</q-tooltip>
          </q-btn>
          ...
          >
            ...
            <q-tooltip :delay="500">{{
              t("alerts.incidents.editIncidentTitleTooltip")
            }}</q-tooltip>
          </q-btn>
        </div>
      </div>
      ...
      >
        ...
        <div class="tw:flex-shrink-0 tw:px-4 tw:pt-3">
          ...
          >
            ...
            />
            <q-tab name="serviceGraph" label="Alert Graph" />
            <q-tab name="alertTriggers">
              <template #default>
                <div class="tw:flex tw:items-center tw:gap-1.5">
                  <span>{{ t("alerts.incidents.alertTriggers") }}</span>
                  <span class="tw:text-sm tw:opacity-70"
                    >({{ triggers.length }})</span
                  >
                </div>
              </template>
            </q-tab>
        ...
        <div class="tw:flex tw:flex-1 tw:overflow-hidden">
          ...
          <div
            class="tabs-content-column tw:flex-1 tw:flex tw:flex-col tw:overflow-hidden"
            style="order: 2"
          >
            <!-- Tab Content Area -->
            <div
              class="tw:flex-1 tw:flex tw:flex-col tw:px-2 tw:pt-4 tw:pb-2 tw:overflow-hidden tw:relative"
            >
              ...
              >
                    ...
                    <div
                      :class="
                        store.state.theme === 'dark'
                          ...
                          : 'tw:text-gray-900'
                      "
                      class="tw:text-3xl tw:font-semibold tw:leading-none"
                    >
                      {{ triggers.length }}
                    </div>
                  </div>
                    ...
                    <div
                      :class="
                        store.state.theme === 'dark'
                          ...
                          : 'tw:text-gray-900'
                      "
                      class="tw:text-2xl tw:font-semibold tw:leading-none"
                    >
                      {{
                    ...
                    <div
                      :class="
                        store.state.theme === 'dark'
                          ...
                          : 'tw:text-gray-900'
                      "
                      class="tw:text-lg tw:font-semibold tw:leading-tight"
                    >
                      {{ alertFrequency }}
                    </div>
                  </div>
                ...
                <div
                  class="tw:flex tw:gap-3 tw:flex-1"
                ...
                >
                  ...
                  >
                    ...
                    <div class="tw:flex tw:gap-3" style="height: 50%">
                      ...
                      >
                        ...
                        <div
                          class="tw:flex tw:flex-col tw:gap-6 tw:px-4 tw:py-2 tw:overflow-y-auto tw:relative"
                        >
                          <!-- Vertical line -->
                          <div
                          ...
                          <div
                            class="tw:flex tw:items-start tw:gap-3 tw:relative"
                          >
                            <div
                            ...
                            <div class="tw:flex-1">
                              ...
                              >
                                ...
                                >
                                <span>{{
                                  t("alerts.incidents.initialTrigger")
                                }}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          >
                            ...
                            <div class="tw:flex-1">
                              ...
                              >
                                ...
                                >
                                <span
                                  >{{ peakActivity.count }} alerts in 5
                                  mins</span
                                >
                              </div>
                            </div>
                        ...
                        <div
                          class="tw:border-t tw:border-gray-200 dark:tw:border-gray-700 tw:p-2 tw:flex tw:justify-end"
                        >
                          <q-btn
                            flat
                            dense
                      ...
                      >
                        ...
                        <!-- Content -->
                        <div
                          class="tw:flex tw:flex-col tw:gap-3 tw:p-4 tw:overflow-y-auto"
                        >
                          <!-- Incident ID -->
                          <div
                          ...
                          >
                            ...
                            >
                              <span class="tw:truncate tw:flex-1 tw:min-w-0">{{
                              ...
                              <q-icon
                                ...
                                :class="
                                  copiedField === 'incident_id'
                                    ? 'tw:text-green-500'
                                    : 'tw:opacity-60 hover:tw:opacity-100 hover:tw:text-blue-500'
                                "
                          ...
                          >
                            ...
                            >
                              <span class="tw:truncate tw:flex-1 tw:min-w-0">{{
                                incidentDetails?.correlation_key || "N/A"
                              }}</span>
                              <q-icon
                                :name="
                                  copiedField === 'correlation_key'
                                    ? 'check'
                                    : 'content_copy'
                                "
                                :class="
                                ...
                                @click="
                                  copyToClipboard(
                                    incidentDetails?.correlation_key,
                                    'correlation_key',
                                  )
                                "
                              />
                  ...
                  >
                    ...
                    >
                      ...
                      <!-- Content -->
                      <div
                        class="tw:flex tw:flex-col tw:gap-3 tw:p-3 tw:overflow-y-auto"
                      >
                        <!-- Status Section -->
                    ...
                    >
                      ...
                      <!-- Content -->
                      <div
                        class="tw:flex tw:flex-col tw:p-3 tw:overflow-y-auto tw:gap-0 tw:flex-1"
                        style="min-height: 0"
                      >
                        <div
                          v-if="
                            incidentDetails?.stable_dimensions &&
                            Object.keys(incidentDetails.stable_dimensions)
                              .length > 0
                          "
                        ...
                        >
                          <div
                            v-for="(
                              value, key
                            ) in incidentDetails.stable_dimensions"
                            :key="key"
                    ...
                    >
                      ...
                      <div
                        class="tw:px-3 tw:pb-3 tw:overflow-y-auto tw:flex-1"
                        style="min-height: 0"
                      >
                        <div class="tw:flex tw:flex-col tw:gap-0">
                          <div
                            ...
                            :class="{
                              'tw:border-b-0':
                                index === sortedAlertsByTriggerCount.length - 1,
                            }"
                          >
                            <div
                              :class="
              ...
              <div
                v-if="activeTab === 'alertTriggers'"
                class="tw:flex tw:flex-1 tw:overflow-hidden"
              >
                <!-- Left Section: Alert Triggers Table -->
                <div
                  class="tw:flex-1 tw:flex tw:flex-col tw:overflow-hidden tw:pr-2 tw:pt-4"
                >
                  <div
                    :class="[
                ...
                <div
                  class="tw:w-[400px] tw:flex-shrink-0 tw:flex tw:flex-col tw:pt-4"
                >
                  <div
                    :class="[
                      'section-container tw:overflow-hidden tw:flex tw:flex-col tw:flex-1',
...
size="16px" class="tw:opacity-80" />
                    ...
                    <div class="tw:p-3 tw:flex-1 tw:overflow-auto">
                      ...
                      <div v-else class="tw:flex tw:flex-col tw:gap-3">
                        ...
                        <div class="tw:space-y-2">
                            ...
                            <span
                              :class="
                                store.state.theme === 'dark'
                                  ...
                                  : 'tw:text-gray-500'
                              "
                              class="tw:text-[10px] tw:uppercase tw:tracking-wide"
                            >
                              Alert Name
                            </span>
                            <span
                          ...
                          <div class="tw:grid tw:grid-cols-2 tw:gap-2">
                            <div class="tw:flex tw:flex-col tw:gap-0.5">
                              ...
                              >
                                {{
                                  alerts[selectedAlertIndex]?.trigger_condition
                                    ?.operator || ""
                                }}
                                {{
                                  alerts[selectedAlertIndex]?.trigger_condition
                        ...
                        <div
                          :class="[
                            'tw:rounded tw:border tw:flex tw:flex-col section-container',
                          ]"
                        ...
                        >
                          <div
                            :class="[
                              'section-header-bg tw:px-2.5 tw:py-1.5 tw:border-b tw:flex tw:items-center tw:justify-between tw:flex-shrink-0',
                              store.state.theme === 'dark'
                                ? 'tw:border-gray-700'
                                : 'tw:border-gray-200',
                            ]"
                            ...
                            <span
                              :class="
                                store.state.theme === 'dark'
                                  ...
                                  : 'tw:text-gray-700'
                              "
                              class="tw:text-[11px] tw:font-semibold tw:uppercase tw:tracking-wide"
                            >
                              {{
                                alerts[selectedAlertIndex]?.query_condition
                                  ?.type === "sql"
                                  ? "SQL Query"
                                  : alerts[selectedAlertIndex]?.query_condition
                                        ?.type === "promql"
                          ...
                          <div class="tw:p-2.5 tw:overflow-y-auto tw:flex-1">
                            ...
                            <div
                              v-if="
                                alerts[selectedAlertIndex]?.query_condition?.sql
                              "
                            >
                              <pre
                                :class="[
                                  'tw:text-[10px] tw:overflow-x-auto tw:whitespace-pre-wrap tw:break-words',
                                  store.state.theme === 'dark'
                                    ? 'tw:text-gray-300'
                                    : 'tw:text-gray-800',
                                ]"
...
if {{
              ...
              >
                ...
                <div
                  ...
                  class="tw:flex tw:flex-col tw:items-center tw:justify-center tw:flex-1 tw:h-[70vh]"
                >
                  <q-spinner-hourglass
                    color="primary"
                    size="3rem"
                ...
                <div
                  v-else-if="
                    correlationError || !hasCorrelatedData || !hasAnyStreams
                  "
                ...
                >
                  <q-icon
                    :name="
                      correlationError
                        ? correlationError.includes('FQN priority')
                          ? 'warning'
                          : 'error_outline'
                        : 'info_outline'
                    "
                  ...
                  >
                    The service discovery configuration (FQN priority
                    dimensions) was changed after this incident was created.
                  </div>
                  <q-btn
                    v-if="
                      correlationError &&
              ...
              >
                ...
                <div
                  v-if="
                    hasCorrelatedData &&
                    !correlationLoading &&
                    correlationData?.traceStreams?.length > 0
                  "
                  class="tw-px-4 tw-py-2 tw-border-b tw-border-solid tw-border-[var(--o2-border-color)] tw-flex tw-items-center tw-justify-between"
                >
                  <span class="tw-text-xs tw-text-gray-500">{{
                    t("alerts.incidents.showingCorrelatedTraces")
                  }}</span>
                  <q-btn
                    flat
                    dense
                  ...
                  >
                    <q-tooltip>{{
                      t("alerts.incidents.refreshCorrelatedData")
                    }}</q-tooltip>
                  </q-btn>
                </div>
...
import {
  contextRegistry,
  createIncidentsContextProvider,
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const alertFrequency = computed(() => {
      ...
      const durationMs =
        (incidentDetails.value.last_alert_at -
          incidentDetails.value.first_alert_at) /
        1000;
      ...
      if (frequency >= 1) {
        ...
        const minutesBetween = Math.floor(
          durationSeconds / triggers.value.length / 60,
        );
    ...
    const peakAlertRate = computed(() => {
      ...
      for (let i = 0; i < sortedTriggers.length; i++) {
        ...
        for (
          let j = i;
          j < sortedTriggers.length &&
          sortedTriggers[j].alert_fired_at < windowEnd;
          j++
        ) {
          count++;
        }
    ...
    const buildFallbackCorrelation = async (
      org: string,
      incident: Incident,
    ) => {
      try {
        ...
        const semanticGroupsResponse =
          await serviceStreamsApi.getSemanticGroups(org);
        const semanticGroups = semanticGroupsResponse.data;

        const filters: Record<string, string> = {};

        // Step 4: For each dimension, find the matching schema field
        for (const [dimId, dimValue] of Object.entries(
          incident.stable_dimensions,
        )) {
          ...
          if (group && group.fields && group.fields.length > 0) {
            ...
            console.warn(
              `[Fallback Correlation] No semantic group found for: ${dimId}`,
            );
          }
          ...
          if (!matchedField) {
            ...
            const schemaFieldsArray = Array.from(schemaFields).filter(
              (f) => !f.startsWith("_"),
            );
        ...
        if (Object.keys(filters).length === 0) {
          console.warn(
            "[Fallback Correlation] No dimensions could be mapped to stream fields",
          );
          return;
        }
        ...
        console.error(
          "[Fallback Correlation] Failed to build fallback:",
          fallbackError,
        );
    ...
    const telemetryTimeRange = computed(() => {
      ...
      const startTime =
        incidentDetails.value.first_alert_at - FIFTEEN_MINUTES_MICROS;
      const endTime =
        incidentDetails.value.last_alert_at + FIFTEEN_MINUTES_MICROS;
    ...
    const formattedRcaContent = computed(() => {
      const content =
        rcaLoading.value && rcaStreamContent.value
          ? rcaStreamContent.value
    ...
    const alertActivityChartData = computed(() => {
      ...
      const triggersByDay: Record<
        string,
        { total: number; byAlert: Record<string, number> }
      > = {};
      ...
      const seriesData = Array.from(alertNames).map((alertName, index) => {
        ...
        return {
          ...
          data: sortedDates.map(
            (date) => triggersByDay[date].byAlert[alertName] || 0,
          ),
          itemStyle: {
      ...
      return {
        ...
        legend: {
          ...
          pageIconInactiveColor:
            store.state.theme === "dark" ? "#666666" : "#CCCCCC",
          pageTextStyle: {
            color: store.state.theme === "dark" ? "#DCDCDC" : "#232323",
          },
        },
    ...
    watch(
      ...
      (contextData) => {
        if (contextData) {
          const incidentProvider = createIncidentsContextProvider(
            contextData,
            store,
          );
    ...
    const updateStatus = async (
      ...
      try {
        ...
        incidentDetails.value.updated_at =
          response.data.updated_at || Date.now() * 1000;
        editableStatus.value = response.data.status;
        $q.notify({
          type: "positive",
    ...
    const saveTitleEdit = async () => {
      ...
      try {
        ...
        $q.notify({
          type: "negative",
          message:
            error?.response?.data?.message || "Failed to update incident title",
          timeout: 3000,
        });
        cancelTitleEdit();
      }
    ...
    const handleTriggerRowClick = (alertName: string) => {
      const index = alerts.value.findIndex(
        (alert: any) => alert.name === alertName,
      );
      if (index !== -1) {
        ...
        if ("analysis_in_flight" in data) {
          ...
          if (data.analysis_in_flight) {
            ...
            $q.dialog({
              ...
              message:
                "Severity has changed. Would you like AI to re-analyze this incident?",
              cancel: { label: "No thanks", flat: true },
              ok: { label: "Re-run AI analysis", color: "primary" },
              persistent: false,
            }).onOk(async () => {
              try {
                await incidentsService.triggerRca(org, incidentId, {
                  reanalysis: true,
                });
                $q.notify({
                  type: "positive",
                ...
                $q.notify({
                  type: "negative",
                  message:
                    e?.response?.data?.message || "Failed to start reanalysis",
                  timeout: 3000,
                });
              }
            });
    ...
    const extractTableOfContents = (content: string): TocItem[] => {
      ...
      lines.forEach((line) => {
        ...
        if (match) {
          ...
          while (
            stack.length > 0 &&
            stack[stack.length - 1].level >= displayLevel
          ) {
            stack.pop();
          }
    ...
    const scrollToSection = (id: string) => {
      ...
      setTimeout(() => {
        ...
        const rcaContainers = Array.from(
          document.querySelectorAll(".rca-container"),
        );
        ...
        renderer: {
          ...
          list(token: any) {
            ...
            const classes = token.ordered
              ? "rca-ol tw:pl-5 tw:my-3 tw:space-y-1.5 tw:list-decimal"
              : "rca-ul tw:pl-5 tw:my-3 tw:space-y-1.5 tw:list-disc";
      ...
      try {
        ...
        $q.notify({
          ...
          message:
            error?.response?.data?.message ||
            error?.message ||
            "Failed to perform RCA analysis",
        });
      } finally {
...
body.body--dark
  .tabs-content-column
  .tw:overflow-auto::-webkit-scrollbar-thumb {
  background: #475569;
}
