      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props">
          ...
          <q-btn
            ...
            @click="deleteDestination(props)"
          ></q-btn>
        </q-td>
      </template>
      <template #top>
        <div class="q-table__title">
          {{ t("destinations.header") }}
        </div>
        <q-input
