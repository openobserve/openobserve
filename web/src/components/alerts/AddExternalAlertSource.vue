  ...
  computed: {
    ...
    sourceTypeOptions() {
      return [
        ...
        { label: this.t("alert_sources.sourceTypes.alertmanager"), value: "alertmanager" },
        { label: this.t("alert_sources.sourceTypes.generic"), value: "generic" },
        { label: this.t("alert_sources.sourceTypes.auto"), value: "auto" },
      ];
    },
  },
  methods: {
