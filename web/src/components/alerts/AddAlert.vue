    ...
    <!-- ═══════════════════════════════════════════════════════════════════ -->
        ...
        <template #tabs>
          ...
          >
            <div class="flex items-center gap-1.5 shrink-0">
              <div class="text-xs font-semibold whitespace-nowrap text-text-label">{{ isAnomalyMode ? t('alerts.anomalyName') : t('alerts.incidents.alertName') }} <span class="text-text-heading">*</span></div>
              <OFormInput
                v-if="!isAnomalyMode"
                ref="step1Ref"
                name="name"
      ...
      <div class="bg-card-glass-bg shrink-0 stream-config-card [container-type:inline-size] [container-name:stream-config]">
        <div class="flex items-center gap-0 py-2.5 px-3 border-b border-border-default">
          ...
          <span class="text-compact font-semibold tracking-[0.01em]">{{ t('alerts.streamConfig') }} <span class="text-text-heading">*</span></span>
        </div>
        <div class="flex items-center gap-4 px-3 py-2">
        <!-- Stream Type -->
        <div class="flex items-center gap-1.5">
          <div class="text-xs font-semibold whitespace-nowrap text-text-label">{{ t("alerts.streamType") }} <span class="text-text-heading">*</span></div>
          <OFormSelect
            ref="streamTypeRef"
            name="stream_type"
        ...
        <!-- Stream Name -->
        <div class="flex items-center gap-1.5">
          <div class="text-xs font-semibold whitespace-nowrap text-text-label">{{ t("alerts.stream_name") }} <span class="text-text-heading">*</span></div>
          <OFormSelect
            ref="streamNameRef"
            name="stream_name"
