          ...
          <div v-if="isRealTime === 'false'" class="alert-condition-rows">
            ...
            <template v-if="isEventBased">
              ...
              <div class="alert-condition-row" data-test="alert-if-row-logs">
                <span class="condition-label">{{ t('alerts.threshold') }}*</span>
                <div class="tw:flex tw:flex-nowrap tw:items-center tw:gap-2">
                  ...
                  <template v-if="selectedFunction !== 'total_events'">
                    <span class="condition-text">{{ t('alerts.conditionOf') }}</span>
                    <OSelect
                  ...
                  <template v-if="selectedFunction === 'total_events'">
                    ...
                    />
                    <span v-if="streamName" class="condition-text">{{ t('alerts.matchingTypeFound', { type: streamType === 'traces' ? 'traces' : 'logs' }) }}</span>
                  </template>

                  <!-- MEASURE mode -->
                  <template v-else>
                    <span class="condition-text">{{ t('alerts.conditionIs') }}</span>
                    <OSelect
                ...
                <div class="tw:flex tw:flex-nowrap tw:items-center tw:gap-2">
                  ...
                  <template v-if="selectedFunction === 'total_events'">
                    ...
                    <OInput
                      ...
                      @update:model-value="triggerThresholdError = ''; onTriggerThresholdChange($event)"
                    />
                    <span class="condition-text">{{ t('alerts.matchingMetricsFound') }}</span>
                  </template>
        ...
        <div class="tw:w-full tw:flex tw:flex-col tw:gap-2 tw:overflow-hidden">
              ...
              <div style="display: flex; flex-direction: column; flex-shrink: 0; overflow: hidden;"
                ...
                <div class="inline-editor-header tw:flex tw:items-center tw:justify-between">
                  <div class="tw:flex tw:items-center tw:gap-2">
                    ...
                    <span class="inline-editor-title">{{ localTab === 'sql' ? t('alerts.sqlEditor') : t('alerts.promqlEditor') }}</span>
                  </div>
          ...
          <div v-if="isRealTime === 'false'" class="alert-condition-rows tw:mt-2 tw:px-1">
            ...
            <div v-if="localTab === 'sql'" class="alert-condition-row">
              <span class="condition-label sql-promql-label">{{ t('alerts.alertIfNoOfEvents') }} *</span>
              <div class="tw:flex tw:items-center tw:gap-2">
                <OSelect
                  v-model="triggerOperator"
                  :options="numericOperators"
            ...
            <template v-if="localTab === 'promql' && promqlCondition">
              <div class="alert-condition-row">
                <span class="condition-label sql-promql-label">{{ t('alerts.alertIfValueIs') }} *
              ...
              <div class="alert-condition-row">
                <span class="condition-label sql-promql-label">{{ t('alerts.havingSeries') }} *
