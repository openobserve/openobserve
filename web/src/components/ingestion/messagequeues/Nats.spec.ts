...
vi.mock('@/composables/useIngestion', () => ({
  default: vi.fn(() => ({
    ...
    messageQueuesDocURLs: {
      nats: 'https://short.openobserve.ai/messagequeues/nats',
    },
  })),
}));
...
describe('Nats.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with nats', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('nats');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('nats');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('NATS');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/messagequeues/nats');
    });
  });
