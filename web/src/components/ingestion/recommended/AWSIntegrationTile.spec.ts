...
vi.mock("@/utils/awsIntegrations", () => ({
  generateCloudFormationURL: vi.fn(
    () => "https://console.aws.amazon.com/cloudformation?stackName=test",
  ),
...
vi.mock("./WindowsConfig.vue", () => ({
  default: {
    name: "WindowsConfig",
    template: "<div>Windows Config</div>",
...
const createMockIntegration = (overrides = {}) => ({
  ...
  hasDashboard: true,
  dashboardGithubUrl:
    "https://raw.githubusercontent.com/openobserve/dashboards/main/aws/cloudwatch.json",
