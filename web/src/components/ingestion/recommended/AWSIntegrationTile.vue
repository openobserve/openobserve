...
<template>
  <OCard
    class="border border-border h-full flex flex-col transition-all duration-200 ease-in-out rounded-default hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_12px_rgba(255,255,255,0.1)]"
  >
