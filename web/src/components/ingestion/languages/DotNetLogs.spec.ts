...
import DotNetLogs from './DotNetLogs.vue';
...
vi.mock('@/composables/useIngestion', () => ({
  default: vi.fn(() => ({
    ...
    languagesDocURLs: {
      dotnetlogs: 'https://short.openobserve.ai/languages/dotnetlogs',
    },
  })),
}));
...
describe('DotNetLogs.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with dotnetlogs', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('dotnetlogs');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('dotnetlogs');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('DOTNETLOGS');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass processed content without [STREAM_NAME] to CopyContent', () => {
      ...
      expect(content).toContain('dotnetlogs');
    });
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/languages/dotnetlogs');
    });
  });
