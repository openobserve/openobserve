...
describe('Go.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with go', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('go');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('go');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      const content = (wrapper.vm as any).content;
      expect(content).toBe(content.replace(/GO/g, 'go'));
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/languages/go');
    });
  });
