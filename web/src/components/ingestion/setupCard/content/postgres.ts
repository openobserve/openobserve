...
export default function postgresCard(subs: CardSubstitutions, t: TranslateFn): RichCardContent {
  ...
  return {
    provider: {
      ...
      // blocking-chain events into the _o2_dbm_server logs stream.
