...
describe('Oracle.vue Comprehensive Coverage', () => {
  ...
  describe('Component Rendering Tests', () => {
    ...
    it('should render with correct CSS classes', () => {
      ...
      expect(wrapper.find('[class*="tw:font-bold"]').exists()).toBe(true);
    });
    ...
    it('should render documentation text correctly', () => {
      wrapper = createWrapper();
      const docText = wrapper.find('[class*="tw:font-bold"]');
    ...
    it('should render with proper component structure', () => {
      wrapper = createWrapper();
      expect(wrapper.find('.q-pa-sm').exists()).toBe(true);
      expect(wrapper.find('[class*="tw:font-bold"][class*="tw:pt-6"][class*="tw:pb-2"]').exists()).toBe(true);
    });
  });
