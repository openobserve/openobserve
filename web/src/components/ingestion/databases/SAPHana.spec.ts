...
// SAPHana.vue uses name = "sapHana"; after .replace(" ", "_").toLowerCase() => "saphana"
vi.mock('@/composables/useIngestion', () => ({
  ...
  otlphttp/openobserve:
    ...
    databaseDocURLs: {
      sapHana: 'https://short.openobserve.ai/database/saphana',
    },
  })),
}));
...
describe('SAPHana.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should process content with stream name replacement', () => {
      // name = "sapHana" => after replace/toLowerCase => "saphana"
      wrapper = createWrapper();
      const vm = wrapper.vm as any;
      expect(vm.content).toContain('saphana');
    ...
    it('should return correct docURL', () => {
      wrapper = createWrapper();
      const vm = wrapper.vm as any;
      expect(vm.docURL).toBe('https://short.openobserve.ai/database/saphana');
    });
  ...
  describe('Content Processing Tests', () => {
    ...
    it('should process name to lowercase', () => {
      ...
      const vm = wrapper.vm as any;
      expect(vm.content).toContain('saphana');
      expect(vm.content).not.toContain('sapHana');
    });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass processed content to CopyContent', () => {
      ...
      expect(content).toContain('saphana');
    ...
    it('should pass href to documentation link', () => {
      wrapper = createWrapper();
      const docLink = wrapper.find('a');
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/database/saphana');
    });
  });
  ...
  describe('Edge Cases and Error Handling Tests', () => {
    ...
    it('should handle missing saphana docURL', () => {
      wrapper = createWrapper();
      const vm = wrapper.vm as any;
      expect(vm.docURL).toBeDefined();
