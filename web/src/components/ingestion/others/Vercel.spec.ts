...
vi.mock('@/composables/useIngestion', () => ({
  default: vi.fn(() => ({
    ...
    othersDocURLs: {
      vercel: 'https://short.openobserve.ai/others/vercel',
    },
  })),
}));
...
describe('Vercel.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with vercel', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('vercel');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('vercel');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('VERCEL');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/others/vercel');
    });
  });
