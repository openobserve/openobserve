...
import Airbyte from './Airbyte.vue';
...
describe('Airbyte.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with airbyte', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('airbyte');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('airbyte');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('AIRBYTE');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass processed content without [STREAM_NAME] to CopyContent', () => {
      ...
      expect(content).toContain('airbyte');
    });
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/others/airbyte');
    });
  });
