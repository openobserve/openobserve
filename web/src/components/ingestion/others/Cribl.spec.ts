...
vi.mock('@/composables/useIngestion', () => ({
  default: vi.fn(() => ({
    ...
    othersDocURLs: {
      cribl: 'https://short.openobserve.ai/others/cribl',
    },
  })),
}));
...
describe('Cribl.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with cribl', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('cribl');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('cribl');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('CRIBL');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass processed content without [STREAM_NAME] to CopyContent', () => {
      ...
      expect(content).toContain('cribl');
    });
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/others/cribl');
    });
  });
