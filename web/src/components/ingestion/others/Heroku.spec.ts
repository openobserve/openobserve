...
vi.mock('@/composables/useIngestion', () => ({
  default: vi.fn(() => ({
    ...
    othersDocURLs: {
      heroku: 'https://short.openobserve.ai/others/heroku',
    },
  })),
}));
...
describe('Heroku.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with heroku', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('heroku');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('heroku');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('HEROKU');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass processed content without [STREAM_NAME] to CopyContent', () => {
      ...
      expect(content).toContain('heroku');
    });
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/others/heroku');
    });
  });
