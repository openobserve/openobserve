...
describe('Airflow.vue Comprehensive Coverage', () => {
  ...
  describe('Setup Function Tests', () => {
    ...
    it('should replace [STREAM_NAME] with airflow', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).toContain('airflow');
    });
  ...
  describe('Content Processing Tests', () => {
    it('should replace [STREAM_NAME] with processed name', () => {
      ...
      expect(vm.content).toContain('airflow');
    });
    ...
    it('should produce lowercase stream name', () => {
      wrapper = createWrapper();
      expect((wrapper.vm as any).content).not.toContain('AIRFLOW');
    });
  });
  ...
  describe('Component Props Passing Tests', () => {
    ...
    it('should pass correct href to documentation link', () => {
      ...
      expect(docLink.attributes('href')).toBe('https://short.openobserve.ai/others/airflow');
    });
  });
