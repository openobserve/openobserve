        ...
        <div class="max-w-2xl mx-4 mt-4">
          ...
          <template v-if="selectedKind === 'cli'">
            ...
            >
              ...
              <query-editor
                ...
                class="w-full min-h-50! rounded-md border border-card-glass-border resize-y overflow-auto"
                language="yaml"
                :query="cred.value"
          ...
          <template v-if="selectedKind === 'skill'">
            ...
            <query-editor
              ...
              class="w-full min-h-100! rounded-md border border-card-glass-border resize-y overflow-auto mb-3"
              language="markdown"
              :query="skillContent"
