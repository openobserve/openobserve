<template>
  <div v-if="show" class="flex flex-col h-full bg-surface-base border-l border-border-default">
    <div class="correlation-header flex items-center justify-between py-3 px-4 border-b border-border-default bg-surface-panel">
    ...
    <div class="correlation-body flex-1 overflow-y-auto p-4">
      ...
      <div v-if="loading" class="flex flex-col items-center justify-center gap-3 py-8 px-4 text-center">
        <OSpinner size="sm" />
        <span class="text-compact text-text-secondary">Finding related data...</span>
      </div>
      ...
      <div v-else-if="error" class="flex flex-col items-center justify-center gap-3 py-8 px-4 text-center">
        ...
        <span class="text-compact text-status-negative">{{ error }}</span>
      </div>
      ...
      <div v-else-if="!correlationResult" class="flex flex-col items-center justify-center gap-3 py-8 px-4 text-center">
        ...
        <span class="text-compact text-text-secondary">No related telemetry found</span>
      </div>
