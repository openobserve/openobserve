...
describe("TabsSettings", () => {
  ...
  describe("Component Initialization", () => {
    it("should render correctly with default props", async () => {
      ...
      expect(
        wrapper.find('[data-test="dashboard-tab-settings"]').exists(),
      ).toBe(true);
    });
  ...
  describe("Table Structure", () => {
    it("should render table header with correct columns", () => {
      ...
      const nameHeader = wrapper.find(
        '[data-test="dashboard-tab-settings-name"]',
      );
      const actionsHeader = wrapper.find(
        '[data-test="dashboard-tab-settings-actions"]',
      );
  ...
  describe("Tab Display and Interaction", () => {
    it("should display tab names correctly", async () => {
      ...
      const tabNames = wrapper.findAll(
    ...
    it("should render edit buttons for each tab", async () => {
      ...
      const editButtons = wrapper.findAll(
