...
describe("DashboardHeader", () => {
  ...
  describe("Component Initialization", () => {
    it("should render correctly with default props", () => {
      ...
      expect(wrapper.find(".row.items-center.no-wrap.q-mb-sm").exists()).toBe(
        true,
      );
  ...
  describe("Right Slot Functionality", () => {
    ...
    it("should handle multiple elements in right slot", () => {
      wrapper = mount(DashboardHeader, {
        ...
        slots: {
          right:
            '<span data-test="span-1">Span 1</span><span data-test="span-2">Span 2</span>',
        },
        global: {
          plugins: [Quasar],
        },
    ...
    it("should handle empty right slot", () => {
      ...
      const rightSlotContainer =
        rightSlotContainers.length > 0
          ? rightSlotContainers[rightSlotContainers.length - 1]
          : undefined;
