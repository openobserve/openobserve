  ...
  <div class="row items-center">
    ...
    >
      <q-select
        ...
        outlined
        dense
        :model-value="adhocVariables[index].name"
        :display-value="
          adhocVariables[index].name
            ? adhocVariables[index].name
        ...
        :placeholder="adhocVariables[index].name ? '' : 'Select Field'"
    ...
    <q-btn
      class="text-bold no-border q-ml-xs q-mb-sm"
      no-caps
      no-outline
      rounded
      padding="xs"
