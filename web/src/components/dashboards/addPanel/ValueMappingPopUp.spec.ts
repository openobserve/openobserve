...
describe("ValueMappingPopUp", () => {
  ...
  describe("Component Rendering", () => {
    ...
    it("should render header with title and close button", () => {
      ...
      expect(
        wrapper
          .find('[data-test="dashboard-tab-settings-tab-name-edit-cancel"]')
          .exists(),
      ).toBe(true);
    });
  ...
  describe("Drag and Drop", () => {
    ...
    it("should bind draggable to editedValueMapping", () => {
      ...
      if (draggable.exists()) {
        expect(draggable.props("modelValue")).toBe(
          wrapper.vm.editedValueMapping,
        );
      }
    });
  });
