...
const templateMap: Record<string, () => Promise<any>> = {
  ...
  "bar-stack-normalization": () =>
    import("./customChartTemplates/barStackNormalization"),
  "bar-polar-stack-radial": () =>
    import("./customChartTemplates/barPolarStackRadial"),

  // Pie Charts
  "pie-border-radius": () => import("./customChartTemplates/pieBorderRadius"),
  "data-transform-multiple-pie": () =>
    import("./customChartTemplates/dataTransformMultiplePie"),

  // Scatter Charts
  "scatter-matrix": () => import("./customChartTemplates/scatterMatrix"),
  "scatter-polynomial-regression": () =>
    import("./customChartTemplates/scatterPolynomialRegression"),
  ...
  "data-transform-aggregate": () =>
    import("./customChartTemplates/dataTransformAggregate"),
  ...
  "dataset-series-layout": () =>
    import("./customChartTemplates/datasetSeriesLayout"),
  ...
  "scatter3d-scatter-matrix": () =>
    import("./customChartTemplates/scatter3dScatterMatrix"),
 ...
 */
export async function loadCustomChartTemplate(
  chartValue: string,
): Promise<CustomChartTemplateModule | null> {
