  ...
  <div>
    ...
    <q-select v-if="dashboardPanelData.data.type == 'geomap'" outlined
      ...
      <div v-if="dashboardPanelData.data.type == 'geomap'">
        ...
        <div class="row">
          <q-input  v-model="dashboardPanelData.data.config.map_view.lat" label="Latitude" color="input-border"
            bg-color="input-bg" class="col-6 q-py-md showLabelOnTop" stack-label outlined filled dense label-slot :type="'number'">
          </q-input>
          <q-input v-model="dashboardPanelData.data.config.map_view.lng" label="Longitude" color="input-border"
            bg-color="input-bg" class="col-6 q-py-md showLabelOnTop" stack-label outlined filled dense label-slot :type="'number'">
          </q-input>
        </div>
        <q-input v-model="dashboardPanelData.data.config.map_view.zoom" label="Zoom" color="input-border"
