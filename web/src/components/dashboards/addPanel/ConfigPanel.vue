...
<template>
  <div>
    ...
    <q-input v-if="(!promqlMode) && (!dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].customQuery)" v-model.number="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.limit"
      :value="0"
      :min="0"
      @update:model-value="(value) => dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.limit = value ? value : 0"
      label="Limit"
      color="input-border"
      bg-color="input-bg"
      class="q-py-md showLabelOnTop"
