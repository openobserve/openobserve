            ...
            >
              <div>
                ...
                <q-btn-group
                  ...
                  "
                >
                  <q-btn :class="(!dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.x[index].sort_by) || dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.x[index].sort_by === 'None' ? 'selected' : ''" @click="updateSortOption(index, 'x', 'None')" icon="block" size="sm" />
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.x[index].sort_by === 'ASC' ? 'selected' : ''" @click="updateSortOption(index, 'x', 'ASC')"><AscSort/></q-btn>
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.x[index].sort_by === 'DESC' ? 'selected' : ''" @click="updateSortOption(index, 'x', 'DESC')"><DescSort/></q-btn>
                </q-btn-group>
              </div>
            </q-menu>
          </q-btn>
            ...
            >
              <div>
                ...
                <q-btn-group
                    ...
                    "
                  >
                  <q-btn :class="(!dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.y[index].sort_by) || dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.y[index].sort_by === 'None' ? 'selected' : ''" @click="updateSortOption(index, 'y', 'None')" icon="block" size="sm" />
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.y[index].sort_by === 'ASC' ? 'selected' : ''" @click="updateSortOption(index, 'y', 'ASC')" ><AscSort/></q-btn>
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.y[index].sort_by === 'DESC' ? 'selected' : ''" @click="updateSortOption(index, 'y', 'DESC')" ><DescSort/></q-btn>
                </q-btn-group>
              </div>
            </q-menu>
          </q-btn>
              ...
              <q-menu class="q-pa-md">
                <div>
                  ...
                  <q-btn-group
                    ...
                    "
                  >
                  <q-btn :class="(!dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.z[index].sort_by) || dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.z[index].sort_by === 'None' ? 'selected' : ''" @click="updateSortOption(index, 'z', 'None')" icon="block" size="sm" />
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.z[index].sort_by === 'ASC' ? 'selected' : ''" @click="updateSortOption(index, 'z', 'ASC')" ><AscSort/></q-btn>
                  <q-btn :class="dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields.z[index].sort_by === 'DESC' ? 'selected' : ''" @click="updateSortOption(index, 'z', 'DESC')" ><DescSort/></q-btn>
                </q-btn-group>
                </div>
              </q-menu>
            </q-btn>
...
export default defineComponent({
  ...
  setup() {
    ...
    const updateSortOption = (index:any, field: any, value: any) => {      
      dashboardPanelData.data.queries[dashboardPanelData.layout.currentQueryIndex].fields[field][index].sort_by = value
    }
