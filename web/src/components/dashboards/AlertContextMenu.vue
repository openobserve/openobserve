...
<template>
  <teleport to="body">
    <div
      v-if="visible"
      ref="menuRef"
      class="fixed z-9999 bg-white dark:bg-[#2c2c2c] border border-(--color-border-default) dark:border-[#404040] rounded shadow-[0_2px_8px_rgba(0,0,0,0.15)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.4)] min-w-70 py-1 px-0"
      :style="menuStyle"
      @click.stop
      data-test="alert-context-menu"
    >
      <div
        class="flex items-center py-2 px-4 cursor-pointer [transition:background-color_0.2s] text-sm text-[#333] hover:bg-[#f5f5f5] active:bg-[var(--color-border-default)] dark:text-[var(--color-border-default)] dark:hover:bg-[#383838] dark:active:bg-[#404040]"
