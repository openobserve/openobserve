      ...
      <q-table ref="qTable" :rows="jsTransforms" :columns="columns" row-key="id" :pagination="pagination"
        ...
        <template v-slot:body-cell-actions="props">
          <q-td :props="props">
            ...
            <q-btn :icon="'img:' + getImageURL('images/common/delete_icon.svg')" class="q-ml-xs iconHoverBtn" padding="sm"
              unelevated size="sm" round flat :title="t('function.delete')" @click="showDeleteDialogFn(props)"></q-btn>
          </q-td>
        </template>
        ...
        <template #top="scope">
          ...
          <QTablePagination :scope="scope" :pageTitle="t('function.header')" :position="'top'" :resultTotal="resultTotal"
