...
describe("FrustrationEventBadge.vue", () => {
  ...
  describe("Single Frustration Type", () => {
    it("should render rage_click badge", () => {
      ...
      expect(
        wrapper
          .find('[data-test="frustration-event-badge-rage_click"]')
          .exists(),
      ).toBe(true);
    ...
    it("should render dead_click badge", () => {
      ...
      expect(
        wrapper
          .find('[data-test="frustration-event-badge-dead_click"]')
          .exists(),
      ).toBe(true);
    ...
    it("should render error_click badge", () => {
      ...
      expect(
        wrapper
          .find('[data-test="frustration-event-badge-error_click"]')
          .exists(),
      ).toBe(true);
    ...
    it("should render rage_tap badge", () => {
      ...
      expect(
        wrapper.find('[data-test="frustration-event-badge-rage_tap"]').exists(),
      ).toBe(true);
    ...
    it("should render error_tap badge", () => {
      ...
      expect(
        wrapper
          .find('[data-test="frustration-event-badge-error_tap"]')
          .exists(),
      ).toBe(true);
  ...
  describe("Tooltip Content", () => {
    it("should show correct tooltip for rage_click", () => {
      ...
      const badge = wrapper.find(
        '[data-test="frustration-event-badge-rage_click"]',
      );
  ...
  describe("Data Test Attributes", () => {
    it("should have wrapper data-test attribute", () => {
      wrapper = createWrapper(["rage_click"]);
      expect(
        wrapper.find('[data-test="frustration-event-badge-wrapper"]').exists(),
      ).toBe(true);
    });
  ...
  describe("Unknown Frustration Type", () => {
    it("should handle unknown frustration type gracefully", () => {
      ...
      expect(
        wrapper
          .find('[data-test="frustration-event-badge-unknown_type"]')
          .exists(),
      ).toBe(true);
  ...
  describe("Reactivity", () => {
    it("should update when frustrationTypes prop changes", async () => {
      ...
      await wrapper.setProps({
        frustrationTypes: ["rage_click", "dead_click"],
      });
      expect(wrapper.findAll(".frustration-event-badge")).toHaveLength(2);
    });
