...
describe("FrustrationBadge.vue", () => {
  ...
  describe("Severity Levels", () => {
    it('should render "—" when count is 0', () => {
      ...
      expect(
        wrapper.find('[data-test="frustration-badge-none"]').exists(),
      ).toBe(true);
    ...
    it("should render low severity badge for count 1-3", () => {
      ...
      expect(wrapper.find('[data-test="frustration-badge-low"]').exists()).toBe(
        true,
      );
    ...
    it("should render medium severity badge for count 4-7", () => {
      ...
      expect(
        wrapper.find('[data-test="frustration-badge-medium"]').exists(),
      ).toBe(true);
    ...
    it("should render high severity badge for count 8+", () => {
      ...
      expect(
        wrapper.find('[data-test="frustration-badge-high"]').exists(),
      ).toBe(true);
  ...
  describe("Data Test Attributes", () => {
    it("should have correct data-test attribute for container", () => {
      wrapper = createWrapper(5);
      expect(
        wrapper.find('[data-test="frustration-badge-container"]').exists(),
      ).toBe(true);
    });
