...
<template>
  ...
  >
    <div
      class="step-content tw:px-3 tw:py-4 tw:rounded-lg tw:h-full tw:overflow-y-auto tw:border"
      :class="store.state.theme === 'dark' ? 'tw:bg-[var(--o2-primary-background)] tw:border-[#343434]' : 'tw:bg-white tw:border-[#e6e6e6]'"
    >
