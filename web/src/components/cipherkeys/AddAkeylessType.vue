...
<template>
  <div class="cipher-keys-add-akeyless-type">
    ...
    <div v-else>
      ...
      <pre class="[text-wrap:auto] break-words border border-input-border p-[5px] mb-[5px]">{{ formData.key.store.akeyless.access_id }}</pre>
    ...
    >
      ...
      <div v-if="formData.key.store.akeyless.auth.type === 'access_key'">
        ...
        <div v-else>
          ...
          <pre class="[text-wrap:auto] break-words border border-input-border p-[5px] mb-[5px]">{{ formData.key.store.akeyless.auth.access_key }}</pre>
      ...
      <div v-if="formData.key.store.akeyless.auth.type === 'ldap'">
        ...
        <div v-else>
          ...
          <pre class="[text-wrap:auto] break-words border border-input-border p-[5px] mb-[5px]">{{ formData.key.store.akeyless.auth.ldap.username }}</pre>
        ...
        <div v-else>
          ...
          <pre class="[text-wrap:auto] break-words border border-input-border p-[5px] mb-[5px]">{{ formData.key.store.akeyless.auth.ldap.password }}</pre>
