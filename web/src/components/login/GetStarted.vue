  ...
  <div class="tw:flex tw:h-screen">
      ...
      >
        <div style="margin-bottom: 34px; margin-left: 32px">
          ...
          <div
            ...
            "
          >
            Try OpenObserve today for more efficient and performant
            observability.
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div class="tw:flex tw:flex-col tw:items-center tw:mb-4">
        ...
        />
        <div
          class="tw:text-[24px] md:tw:text-[32px] tw:font-semibold tw:text-center"
          :class="[
      ...
      <div class="tw:w-full tw:flex tw:justify-center">
        <div
          class="tw:w-full tw:max-w-[500px] tw:flex tw:flex-col tw:items-center tw:gap-y-2 tw:px-4"
        >
          <q-input
          ...
          <div class="tw:w-full tw:flex tw:items-center tw:ml-[-18px]">
            <q-checkbox v-model="isAgree" class="tw:items-center">
              <span class="tw:text-sm">
                ...
                <a href="#" class="tw:text-[#6B76E3] hover:underline"
                  >Terms of use</a
                >
                and
                <a href="#" class="tw:text-[#6B76E3] hover:underline"
      ...
      <!-- Footer -->
      <div
        class="tw:absolute tw:bottom-5 tw:text-sm tw:mb-[16px]"
        :class="[
          store.state.theme == 'dark'
            ? 'tw:text-[#ffffff]'
            : 'tw:text-[#767676]',
...
const onSubmit = async () => {
  ...
  const res = await billings.submit_new_user_info(
