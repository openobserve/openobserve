...
describe('DynamicFilterIcon.vue', () => {
  ...
  const createWrapper = () => mount(DynamicFilterIcon, { global: { plugins: [Quasar] } });
  ...
  describe('Component Rendering', () => {
    ...
    it('has correct component name', () => {
      wrapper = createWrapper();
      expect(wrapper.vm.$options.name).toBe('DynamicFilterIcon');
    });
  ...
  describe('Icon Specifics', () => {
    it('represents a filter / funnel icon', () => {
      wrapper = createWrapper();
      expect(wrapper.vm.$options.name).toBe('DynamicFilterIcon');
    });
