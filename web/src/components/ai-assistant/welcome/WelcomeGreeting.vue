...
<template>
  <header class="welcome-hero flex flex-col items-center text-center gap-[0.625rem] max-w-[44rem]">
    ...
    <div class="welcome-hero__tagline mt-1 text-sm leading-[1.6] text-typography-meta max-w-[38rem] m-0">
      ...
      <span class="welcome-hero__code welcome-hero__code--sql font-[var(--font-mono,ui-monospace,SFMono-Regular,Menlo,monospace)] text-xs font-semibold py-px px-1.5 rounded-sm tracking-[0.01em] text-lang-sql-text bg-lang-sql-bg">{{
        t("aiAssistant.welcome.taglineSql")
      }}</span>,
      <span class="welcome-hero__code welcome-hero__code--vrl font-[var(--font-mono,ui-monospace,SFMono-Regular,Menlo,monospace)] text-xs font-semibold py-px px-1.5 rounded-sm tracking-[0.01em] text-lang-vrl-text bg-lang-vrl-bg">{{
        t("aiAssistant.welcome.taglineVrl")
      }}</span>
      and
      <span class="welcome-hero__code welcome-hero__code--promql font-[var(--font-mono,ui-monospace,SFMono-Regular,Menlo,monospace)] text-xs font-semibold py-px px-1.5 rounded-sm tracking-[0.01em] text-lang-promql-text bg-lang-promql-bg">{{
