...
<template>
  <section class="flex flex-col gap-3 w-full">
    ...
    <div class="suggestions-grid grid w-full gap-2 md:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1">
      ...
      >
        <span class="suggestion-chip__icon inline-flex items-center justify-center shrink-0 w-5.5 h-5.5 rounded-md bg-[color-mix(in_srgb,var(--color-border-default)_40%,transparent)] text-typography-meta [transition:background_0.15s_ease,color_0.15s_ease] group-hover:bg-[rgba(123,97,255,0.15)] group-hover:text-[#7b61ff]">
