        ...
        <template v-for="row in displayRows" :key="row.key">
          ...
          >
            ...
            >
              ...
              <span class="flex-1 font-medium text-sm text-text-primary min-w-0 truncate">
                {{ row.label }}
            ...
            <div v-if="expandedGroups[row.key]" class="px-3 pb-2 space-y-1">
              <div
                ...
                :key="child.id"
                class="flex flex-col gap-1 pl-6 pr-2 py-1.5 rounded"
              ...
              >
                <div class="flex items-center gap-3">
                  ...
                  />
                  <span class="flex-1 text-sm text-text-primary min-w-0 truncate">
                ...
                <div
                  ...
                  class="ml-6 text-xs text-error bg-surface-secondary rounded px-2 py-1 break-words whitespace-pre-wrap"
                >
                  {{ child.last_error }}
                </div>
              </div>
          ...
          <div
            v-else
            class="flex flex-col gap-1 px-3 py-2 rounded"
          ...
          >
            ...
            <div
              ...
              class="ml-8 text-xs text-error bg-surface-secondary rounded px-2 py-1 break-words whitespace-pre-wrap"
            >
              {{ row.task.last_error }}
            </div>
          </div>
