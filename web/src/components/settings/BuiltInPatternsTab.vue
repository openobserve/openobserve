            ...
            <div class="flex flex-col flex-1 min-w-0 gap-1.5">
              ...
              <div class="flex flex-wrap gap-1">
                <OBadge
                  ...
                  class="text-[11px]! ring-1 ring-inset ring-current"
                >
                  {{ tag }}
                </OBadge>
                <OBadge v-if="pattern.tags.length > 3" size="md" variant="default-soft" class="text-[11px]! ring-1 ring-inset ring-current">
