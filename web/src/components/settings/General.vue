...
<template>
    ...
    >
      ...
      >
        <div class="grid grid-cols-3 gap-4 items-start">
          ...
          <span class="individual-setting-description text-[13px] opacity-70 col-span-2">
  ...
  >
    <div class="space-y-3">
      ...
      <div
        class="flex items-start gap-2 rounded border border-error bg-surface-secondary px-3 py-2"
      >
