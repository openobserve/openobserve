...
describe("OrganizationManagement.vue", () => {
  ...
  beforeEach(async () => {
    ...
    const { default: mockedOrgService } =
      await import("@/services/organizations");
    ...
    return mount(OrganizationManagement, {
      global: {
        ...
        stubs: {
          ...
          "q-input": {
            template:
              '<input class="q-input" v-model="modelValue" :placeholder="placeholder" :data-test="$attrs[\'data-test\']" />',
            props: [
              "modelValue",
              "borderless",
              "filled",
