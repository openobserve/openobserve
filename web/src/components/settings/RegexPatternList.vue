  ...
  >
    ...
    >
      <div
        ...
        data-test="regex-pattern-list-title"
      >
    ...
    >
      <template #no-data>
        <div
          v-if="!listLoading && filterQuery == ''"
          class="full-width column flex-center q-mt-xs full-height"
          style="font-size: 1.5rem"
        >
          <NoRegexPatterns
            @create-new-regex-pattern="createRegexPattern"
            @import-regex-pattern="importRegexPattern"
          />
        </div>
        <div
    ...
    />
    <q-dialog
      v-model="showAddRegexPatternDialog.show"
      position="right"
      full-height
      maximized
    >
