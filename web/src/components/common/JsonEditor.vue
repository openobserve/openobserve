<template>
  ...
  >
    ...
    <div class="tw:h-[calc(100vh-65px)] tw:flex">
      <div
        class="row common-json-editor column tw:h-[calc(100vh-65px)]"
      ...
      <div
        class="q-ml-sm tw:w-[25vw] tw:h-[calc(100vh - 65px)]"
  ...
  setup(props, { emit }) {
    ...
    const handleEditorChange = (value: string) => {
      try {
        ...
        protectedFields.value.forEach((field) => {
          if (
            storedFields.value[field] &&
            newContent[field] !== storedFields.value[field]
          ) {
    ...
    watch(
      ...
      (newVal) => {
        ...
        protectedFields.value.forEach((field) => {
          storedFields.value[field] =
            newVal[field] || storedFields.value[field];
        });
