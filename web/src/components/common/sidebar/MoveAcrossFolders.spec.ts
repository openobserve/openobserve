  ...
  state: {
    ...
    organizationData: {
      foldersByType: {
        ...
        unknown: [{ folderId: "default", name: "Default Unknown Folder" }],
        dashboards: [{ folderId: "default", name: "Default Dashboard Folder" }],
      },
    },
    theme: "light",
  },
...
describe("MoveAcrossFolders.vue", () => {
  ...
  it("should mount successfully with default props", () => {
    ...
    expect(
      wrapper.find('[data-test="alerts-folder-move-header"]').exists(),
    ).toBe(true);
  });
  ...
  it("should render header with correct type in title", () => {
    ...
    expect(wrapper.text().toLowerCase()).toContain(
      "move pipelines to another folder",
    );
  });
  ...
  it("should display current folder name in input field", () => {
    ...
    const currentFolderInput = wrapper.find(
      '[data-test="alerts-folder-move-name"]',
    );
  ...
  it("should render SelectFolderDropDown component with correct props", () => {
    ...
    const selectDropdown = wrapper.findComponent({
      name: "SelectFolderDropDown",
    });
  ...
  it("should handle cancel button click", async () => {
    ...
    const cancelButton = wrapper.find(
      '[data-test="alerts-folder-move-cancel"]',
    );
  ...
  it("should render all card sections", () => {
    ...
    expect(wrapper.find('[data-test="alerts-folder-move-body"]').exists()).toBe(
      true,
    );
  });
