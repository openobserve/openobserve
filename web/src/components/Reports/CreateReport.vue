...
<template>
  <div class="full-width create-report-page">
    ...
    <div
      ...
      style="overflow: auto; scroll-behavior: smooth; width: 1024px"
    >
      <q-form
      ...
      >
        ...
        <q-expansion-item
          ...
          header-class="q-px-sm text-bold"
        >
        ...
        <q-expansion-item
          label="Schedule"
          header-class="q-px-md text-bold"
          class="q-mt-md"
        >
          <div class="q-my-sm q-px-sm">
            ...
            >
              <div
                data-test="add-alert-stream-select"
                class="o2-input"
                style="padding-top: 0; width: 200px"
              >
                <q-input
                  filled
            ...
            <div v-if="formData.frequency !== 'once'" class="q-mt-md">
              <div class="o2-input q-mr-sm">
                <q-input
                  filled
                  v-model="formData.scheduling.date"
