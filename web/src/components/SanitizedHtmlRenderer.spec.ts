...
describe("SanitizedHtmlRenderer.vue", () => {
  ...
  describe("DOMPurify Integration", () => {
    it("calls DOMPurify.sanitize with htmlContent", () => {
      ...
      wrapper = createWrapper({
        htmlContent: '<script>alert("xss")</script><p>Content</p>',
      });
    ...
    it("uses sanitized content for rendering", () => {
      ...
      wrapper = createWrapper({
        htmlContent: '<script>alert("xss")</script><p>Unsafe content</p>',
      });
  ...
  describe("Security Features", () => {
    ...
    it("processes HTML with event handlers", () => {
      ...
      wrapper = createWrapper({
        htmlContent: '<p onclick="alert(1)">Dangerous content</p>',
      });
  ...
  describe("HTML Content Varieties", () => {
    ...
    it("handles complex nested HTML", () => {
      const complexHtml =
        "<div><p>Paragraph</p><ul><li>Item 1</li><li>Item 2</li></ul></div>";
    ...
    it("handles HTML with attributes", () => {
      ...
      wrapper = createWrapper({
        htmlContent: '<p class="test" data-id="123">Content</p>',
      });

      expect(mockSanitize).toHaveBeenCalledWith(
        '<p class="test" data-id="123">Content</p>',
      );
    });
    ...
    it("handles malformed HTML", () => {
      ...
      wrapper = createWrapper({
        htmlContent: "<p>Unclosed paragraph<div>Nested incorrectly",
      });

      expect(mockSanitize).toHaveBeenCalledWith(
        "<p>Unclosed paragraph<div>Nested incorrectly",
      );
    });
  });
  ...
  describe("Component Structure", () => {
    ...
    it("maintains single root element structure", () => {
      ...
      expect(wrapper.element.getAttribute("data-test")).toBe(
