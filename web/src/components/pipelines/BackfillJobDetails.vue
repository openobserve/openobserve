  ...
  >
    ...
    <div v-else-if="job" class="tw:flex tw:flex-col tw:gap-5 tw:px-6 tw:py-4">
          ...
          <div class="tw:flex tw:items-center tw:justify-between">
            <BackfillJobStatusBadge
              :status="job.status"
              :deletion-failed="!!(job.deletion_status && typeof job.deletion_status === 'object' && 'failed' in job.deletion_status)"
            />
            <OButton
              v-if="canCancelJob"
            ...
            <div class="tw:rounded-md tw:border tw:border-card-border tw:bg-card-bg tw:p-4 tw:flex tw:flex-col tw:gap-3">
              <div class="tw:grid tw:grid-cols-2 tw:gap-x-6 tw:gap-y-3">
                <div>
                  ...
                  <BackfillDeletionStatusBadge :status="job.deletion_status" />
                </div>
...
import BackfillJobStatusBadge from "@/components/pipelines/badges/BackfillJobStatusBadge.vue";
import BackfillDeletionStatusBadge from "@/components/pipelines/badges/BackfillDeletionStatusBadge.vue";
