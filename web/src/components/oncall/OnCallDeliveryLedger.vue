...
-->
<template>
  <OCard variant="glass" data-test="oncall-delivery-ledger">
    <OCardSection role="header" dense class="flex-wrap items-baseline">
      <OText variant="card-title">{{ t("oncall.deliveriesTitle") }}</OText>
