...
<template>
  ...
  >
    <div v-if="icon" class="nav-menu-item-avatar tw:flex tw:flex-col tw:items-center tw:gap-0.5 tw:w-full">
      ...
      <div
        class="nav-menu-item-label tw:text-[10.5px] tw:font-medium tw:tracking-[0.01em] tw:transition-colors tw:duration-250 tw:w-full tw:text-center tw:leading-tight tw:line-clamp-2 tw:wrap-normal tw:break-normal tw:[hyphens:none]"
  ...
  >
    <div v-if="icon" class="nav-menu-item-avatar tw:flex tw:flex-col tw:items-center tw:gap-0.5 tw:w-full">
      ...
      <div
        class="nav-menu-item-label tw:text-[10.5px] tw:tracking-[0.01em] tw:transition-colors tw:duration-250 tw:w-full tw:text-center tw:leading-tight tw:line-clamp-2 tw:wrap-normal tw:break-normal tw:[hyphens:none]"
        :class="isActive
          ? activeLabelClass
