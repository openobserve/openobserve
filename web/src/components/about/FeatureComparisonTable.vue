  ...
  setup() {
    ...
    const featureData: FeatureData = {
      ...
      features: [
        ...
        { name: 'Single Sign On (Available only in HA mode)', values: { opensource: false, enterprise: true, cloud: true } },
        { name: 'Role Based Access Control (RBAC) (Available only in HA mode)', values: { opensource: false, enterprise: true, cloud: true } },
