  ...
  >
    ...
    >
      <div class="tw:flex tw:items-center">
        ...
        >
          <span class="breadcrumb-text tw:cursor-pointer"
@click="closeDialog"
            >Stream Details &gt; &nbsp;
          </span>
                  ...
                  >
                    ...
                    >
                      <template v-slot:body="props">
                        <q-tr
                          :data-test="`associated-regex-patterns-applied-patterns-table-row-${props.row.pattern_id}`"
                        ...
                        >
                          <q-td
                            :data-test="`associated-regex-patterns-applied-patterns-table-cell-${props.row.pattern_id}`"
                ...
                <q-card class="q-pa-none q-ma-none" style="height: 100%">
                  ...
                  >
                    ...
                    >
                      <template v-slot:body="props">
                        <q-tr
                          :data-test="`associated-regex-patterns-all-patterns-table-row-${props.row.pattern_id}`"
                        ...
                        >
                          <q-td
                            :data-test="`associated-regex-patterns-all-patterns-table-cell-${props.row.pattern_id}`"
                            class="tw:flex tw:justify-between tw:items-center"
                            style="
                              border-bottom: 0px;
                              font-size: 14px;
                          ...
                          >
                            ...
                            <span
                              v-if="
                                checkIfPatternIsApplied(props.row.pattern_id)
                              "
                            >
                              <q-icon name="check"
size="xs" color="primary" />
      ...
      >
        <div class="tw:flex-1 tw:overflow-y-auto tw:pt-3">
                  ...
                  <div class="tw:flex tw:flex-col tw:gap-0.5">
                    <div class="tw:flex tw:items-center">
                      ...
                      <div class="tw:flex tw:items-center tw:gap-2 tw:ml-1">
                        ...
                        <span class="tw:font-[400] tw:text-[10px] tw:opacity-60"
          ...
          <div class="tw:h-full" v-if="!userClickedPattern">
            ...
            >
              <q-img
                :src="
                  getImageURL('images/regex_pattern/no_applied_pattern.svg')
                "
                style="width: 125px"
              />
              <span
              ...
              >
              <span
                class="no-pattern-applied-subtitle"
                data-test="associated-regex-patterns-no-pattern-applied-subtitle"
                >Browse the pattern library to begin
              </span>
              <span
                class="no-pattern-applied-subtitle"
                data-test="associated-regex-patterns-no-pattern-applied-subtitle"
        ...
        <div
          ...
          "
          class="tw:flex tw:justify-end tw:px-4 tw:py-2"
        >
          <q-btn
            v-close-popup="true"
            label="Cancel"
