...
<template>
  ...
  class="tw:w-[32px] q-my-sm tw:min-w-[32px]!"><q-icon name="add" size="xs" /></OButton>
                  </div>
                </div>
  ...
  data-test="schema-update-settings-button"
  type="submit"
  class="q-ml-md tw:h-[36px">{{ t('logStream.updateSettings') }}</OButton>
                </div>
              </div>
            </div>
            </div>
