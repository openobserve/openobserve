          ...
          <div class="tw:w-full tw:flex tw:gap-2">
            ...
            >
              ...
              <div v-if="activeMainTab == 'schemaSettings'">
                ...
                >
                  <div
                    ...
                    class="tw:mt-[12px]"
                  >
                    <label style="font-weight: 600" class="mapping-warning-msg">
                  ...
                  <div class="flex items-center">
                    <div class="app-tabs-container">
                      ...
                      >
                        ...
                        >
                          <template #icon-left
                            ><UserCheck class="tw:size-3.5 tw:shrink-0"
                          /></template>
                          User Defined Schema ({{
                        ...
                        <OToggleGroupItem value="allFields" size="sm">
                          <template #icon-left
                            ><LayoutList class="tw:size-3.5 tw:shrink-0"
                          /></template>
                ...
                >
                  ...
                  >
                    ...
                    <template v-slot:body-cell-name="props">
                      <q-td
                        class="q-td--no-hover field-name field-name-ellipsis"
                      >
                    ...
                    <template v-slot:body-cell-index_type="props">
                      <q-td data-test="schema-stream-index-select">
                        <q-select
                          ...
                          style="width: 190px"
                          @update:model-value="
                            (val) => updateIndexType(props, val)
                          "
                        >
                          <template v-slot:append>
                            <q-icon
                              v-if="
                                props.row.index_type &&
                                props.row.index_type.length > 0
                              "
                              name="cancel"
                              size="14px"
                              style="
                          ...
                          >
                            {{
                              streamIndexType
                                .filter((opt) =>
                                  props.row.index_type.includes(opt.value),
                                )
                                .map((opt) => opt.label)
                                .join(", ")
                            }}
                    ...
                    <template v-slot:body-cell-patterns="props">
                      <q-td
                        v-if="
                          ...
                          (props.row.type == 'Utf8' || props.row.type == 'utf8')
                        "
                      ...
                      >
                        {{
                          patternAssociations[props.row.name]?.length
                            ? `View ${patternAssociations[props.row.name]?.length} Patterns`
                            : "Add Pattern"
                        }}
                        <span>
              ...
              <div v-if="activeMainTab == 'configuration'">
                <div
                  class="tw:w-full tw:h-[calc(100vh-267px)] tw:flex tw:flex-col tw:gap-4 tw:h-full tw:overflow-y-auto tw:p-4"
                >
              ...
              <div v-else-if="activeMainTab == 'redButton'">
                ...
                >
                  <span style="font-weight: 600">
                    ...
                    Additional
                    {{ store.state.zoConfig.extended_data_retention_days }} days
                    of extension will be applied to the selected date
                    ranges</span
                  >
                </div>
                <div class="q-mt-sm">
