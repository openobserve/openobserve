...
class="note-message" >
            <span class="tw:flex tw:items-center"> <q-icon name="info"
class="q-pr-xs"
<
q-icon> Select an existing stream from the list or enter the name to create a new one</span>
            <span class="tw:flex tw:items-center"> <q-icon name="info"
class="q-pr-xs"
<
q-icon> Enrichment_tables as destination stream is only available for scheduled pipelines</span>

          <span class="tw:flex"> <q-icon name="info"
class="q-pr-xs q-pt-xs"
<
q-icon> Use curly braces '{}' to configure stream name dynamically. e.g. static_text_{fieldname}_postfix. Static text before/after {} is optional</span>
