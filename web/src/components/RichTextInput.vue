<template>
  ...
  >
    ...
    <div
      ...
      @click.stop
    >
      <div class="card-content overflow-y-auto max-h-75 py-1 px-2 font-[Monaco,Menlo,'Courier_New',monospace] text-2xs leading-[1.5] whitespace-pre-wrap break-words text-text-primary"
