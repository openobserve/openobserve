...
!(function (e, t) {
  ...
  var ne = (function t() {
        ...
        if (!mt || mt !== e) {
          if (
            ...
            je &&
              ((Se = N({}, k)),
              (Ne = []),
              !0 === je.html && (N(Se, D), N(Ne, I)),
              !0 === je.svg && (N(Se, L), N(Ne, U), N(Ne, P)),
              !0 === je.svgFilters && (N(Se, v), N(Ne, U), N(Ne, P)),
              !0 === je.mathMl && (N(Se, x), N(Ne, z), N(Ne, P))),
            e.ADD_TAGS && (Se === be && (Se = w(Se)), N(Se, e.ADD_TAGS, ut)),
            e.ADD_ATTR && (Ne === Re && (Ne = w(Ne)), N(Ne, e.ADD_ATTR, ut)),
            e.ADD_URI_SAFE_ATTR && N(Ve, e.ADD_URI_SAFE_ATTR, ut),
            e.FORBID_CONTENTS &&
              (Xe === qe && (Xe = w(Xe)), N(Xe, e.FORBID_CONTENTS, ut)),
            Ge && (Se["#text"] = !0),
            Ie && N(Se, ["html", "head", "body"]),
            Se.table && (N(Se, ["tbody"]), delete Oe.tbody),
    ...
    const Nt = function (e) {
        ...
        if (
          (bt(pe.uponSanitizeElement, e, { tagName: n, allowedTags: Se }),
          e.hasChildNodes() &&
          ...
          : ("noscript" !== n && "noembed" !== n && "noframes" !== n) ||
            ...
            ? (Me &&
                ...
                e.textContent !== t &&
                  ...
                  (e.textContent = t))),
              bt(pe.afterSanitizeElements, e, null),
              !1)
            : (Tt(e), !0);
      },
      Rt = function (e, t, n) {
      ...
      Ot = function (e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            bt(pe.uponSanitizeAttribute, e, n),
            (p = n.attrValue),
            !We ||
              ("id" !== s && "name" !== s) ||
      ...
      Dt = function e(t) {
        ...
        for (bt(pe.beforeSanitizeShadowDOM, t, null); (n = o.nextNode()); )
          (bt(pe.uponSanitizeShadowNode, n, null),
            Nt(n),
            Ot(n),
    ...
    return (
      (o.sanitize = function (e) {
        let t =
          ...
          l = null;
        if (
          ((nt = !e), nt && (e = "\x3c!--\x3e"), "string" != typeof e && !St(e))
        ) {
        ...
        const c = At(Ye ? e : n);
        for (; (i = c.nextNode()); )
          (Nt(i), Ot(i), i.content instanceof s && Dt(i.content));
        if (Ye) return e;
        if (Pe) {
          if (He)
          ...
          return (
            (Ne.shadowroot || Ne.shadowrootmode) && (l = me.call(a, l, !0)),
            l
          );
        }
