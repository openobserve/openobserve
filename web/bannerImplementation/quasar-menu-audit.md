...
| Trigger-width dropdown        | `fit`                                            | Not supported                            | ❌ Not yet implemented — use inline `min-width: 100%` on content                         |
...
| Nested sub-menus              | `<q-menu>` inside `<q-item>`                     | Not exposed                              | ❌ Pending — use custom workaround for `Header.vue` language sub-menu                    |
