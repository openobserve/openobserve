...
describe("PrebuiltDestinationForm", () => {
  ...
  describe("Slack Form", () => {
    it("should render slack fields correctly", () => {
      ...
      expect(
        wrapper.find('[data-test="slack-webhook-url-input"]').exists(),
      ).toBe(true);
    ...
    it("should validate slack webhook URL", async () => {
      ...
      const webhookInput = wrapper.find(
  ...
  describe("PagerDuty Form", () => {
    ...
    it("should have severity options", () => {
      ...
      const severitySelect = wrapper.find(
  ...
  describe("Email Form", () => {
    it("should render email fields correctly", () => {
      ...
      expect(
        wrapper.find('[data-test="email-recipients-input"]').exists(),
      ).toBe(true);
      expect(wrapper.find('[data-test="email-cc-input"]').exists()).toBe(true);
      expect(wrapper.find('[data-test="email-subject-input"]').exists()).toBe(
        true,
      );
    });
    ...
    it("should validate email addresses", () => {
      ...
      const recipientsInput = wrapper.find(
  ...
  describe("ServiceNow Form", () => {
    it("should render servicenow fields correctly", () => {
      ...
      expect(
        wrapper
          .find('[data-test="servicenow-assignment-group-input"]')
          .exists(),
      ).toBe(true);
    });
  });
  ...
  describe("Opsgenie Form", () => {
    it("should render opsgenie fields correctly", () => {
      ...
      expect(
        wrapper.find('[data-test="opsgenie-api-key-input"]').exists(),
      ).toBe(true);
      expect(
    ...
    it("should have priority options", () => {
      ...
      const prioritySelect = wrapper.find(
  ...
  describe("Test Results", () => {
    it("should display success test result", () => {
      ...
      expect(wrapper.find('[data-test="test-result-success"]').exists()).toBe(
        true,
      );
      expect(wrapper.find('[data-test="test-success-message"]').exists()).toBe(
        true,
      );
      expect(
        wrapper.find('[data-test="test-success-timestamp"]').exists(),
      ).toBe(true);
    });
    ...
    it("should display failure test result", () => {
      ...
      expect(wrapper.find('[data-test="test-result-failure"]').exists()).toBe(
        true,
      );
      expect(wrapper.find('[data-test="test-failure-message"]').exists()).toBe(
        true,
      );
      expect(wrapper.find('[data-test="test-retry-button"]').exists()).toBe(
        true,
      );
    });
  ...
  describe("Form Validation", () => {
    it("should validate required fields for each destination type", () => {
      ...
      types.forEach((type) => {
        ...
        const requiredFields = wrapper.findAll(
          "input[required], .q-field--error",
        );
