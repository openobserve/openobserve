---
mode: agent
description: Audit O2 component usage, analyze migration progress in the current branch, and report in table format. Usage — /component-audit [find|diff|status] [component-pattern]
---
