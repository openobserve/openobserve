...
#     # Send the message
#     response_data_histogram_cache = handle_websocket_connection(message_histogram_cashe)

#     print("WebSocket histogram cache response:", response_data_histogram_cache) 
...
#     response_data_sql = handle_websocket_connection(message_sql)

#     print("WebSocket SQL response:", response_data_sql)
...
#     # Send the specific message
#     response_data_sql_cache = handle_websocket_connection(message_sql_cache)

#     print("WebSocket SQL cache response:", response_data_sql_cache)
