...
class PipelinePage:
    ...
    Unique_value_pipeline = f"uPipeline_{random.randint(100000, 999999)}"
    ...
    def create_realTime_pipeline(self, session, base_url, org_id, realTime_pipeline_name, stream_name):
...
def create_scheduled_pipeline(self, session, base_url, org_id, scheduled_pipeline_name, stream_name):
