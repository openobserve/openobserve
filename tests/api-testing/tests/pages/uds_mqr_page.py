...
class UdsMqrPage:
    Unique_value_uds_mqr = f"uUdsMqr_{random.randint(100000, 999999)}"  # Class variable
    ...
    def create_uds_mqr(self, session, base_url, org_id, stream_name, max_query_range_hours):
