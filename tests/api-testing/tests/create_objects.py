...
=======
        ...
        role_page.permission_list(session, base_url, user_email, user_password, org_id, role_name)

        role_page.permission_service_account(session, base_url, user_email, user_password, org_id, serviceaccount_name, role_name)  
...
>>>>>>> bd6aa04c8 (Have updated for dev3 / dev4)
        ...
        # Using the token to create other objects
        ...
        # cipher_page.create_cipher_simpleOO(session, base_url, serviceaccount_name, token, org_id, cipher_name_simpleOO)
        ...
        # # Create alerts
        # alert_webhook = f"alert_webhook_{alert_page.Unique_value_alert}_{i}"
        # alert_page.create_standard_alert(session, base_url, serviceaccount_name, token, org_id, stream_name, template_name_webhook, destination_name_webhook, alert_webhook) 

        # alert_email = f"alert_email_{alert_page.Unique_value_alert}_{i}"  
        # alert_page.create_standard_alert(session, base_url, serviceaccount_name, token, org_id, stream_name, template_name_email, destination_name_email, alert_email)

        # alert_cron = f"alert_cron_{alert_page.Unique_value_alert}_{i}"
        # alert_page.create_standard_alert_cron(session, base_url, serviceaccount_name, token, org_id, stream_name, template_name_email, destination_name_email, alert_cron)

        # alert_real_time = f"alert_real_time_{alert_page.Unique_value_alert}_{i}"
        # alert_page.create_real_time_alert(session, base_url, serviceaccount_name, token, org_id, stream_name, template_name_webhook, destination_name_webhook, alert_real_time)
        ...
        # action_name = f"action{action_page.Unique_value_action}{i}"
        # action_page.create_action(
        #     user_email=serviceaccount_name,
        #     user_password=token,
        #     service_account=serviceaccount_name,
        #     action_name=action_name
        # )
