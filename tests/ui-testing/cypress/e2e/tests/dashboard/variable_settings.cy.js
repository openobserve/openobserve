...
it("should go to variables setting tab and click on add variable and from dropdown select constant", () => {
  ...
  cy.contains(
    ...
    cy.get('[data-test="dashboard-variable-type-selector"]').click({force:true})
    cy.wait(1000);
    cy.contains("Constant").click({force:true})
    cy.wait(1000);
      cy.get('[data-test="dashboard-variable-settings-panel"]')
      .find('[data-test="dashboard-variable-name"]')
      .type(randomDashboardName);
    ...
    cy.wait(1000);
    cy.get('[data-test="dashboard-variable-settings-panel"]')
    .find('[data-test="dashboard-variable-value"]')
    .type(randomDashboardName);
    cy.wait(1000);
    cy.get('[data-test="dashboard-variable-save"]').click({force:true})
    cy.wait(1000);
...
it("should go to variables setting tab and click on add variable and from dropdown select textbox", () => {
  cy.addDashboard();
  cy.get('[data-test="menu-link-/dashboards-item"]').click({ force: true })
  cy.contains(
      '[data-test="dashboard-table"] td',
...
it("should go to variables setting tab and click on add variable and from dropdown select custom", () => {
  cy.addDashboard();
  cy.get('[data-test="menu-link-/dashboards-item"]').click({ force: true })
  cy.contains(
      '[data-test="dashboard-table"] td',
    ...
    cy.wait(1000);
      ...
      .type(randomDashboardName);
    cy.wait(1000);
    cy.get('[data-test="dashboard-variable-option-add"]').click({force:true})
    cy.wait(1000);
    cy.get('[data-test="dashboard-variable-settings-panel"]')
      .find('[data-test="dashboard-variable-option-label"]')
      .type(randomDashboardName);
      cy.get('[data-test="dashboard-variable-settings-panel"]')
      .find('[data-test="dashboard-variable-option-value"]')
      .type(randomDashboardName);
      cy.wait(1000);
    cy.get('[data-test="dashboard-variable-option-remove"]').click({force:true})
    cy.wait(1000);
    cy.get('[data-test="dashboard-variable-save"]').click({force:true})
    cy.wait(1000);
    cy.get('[data-test="dashboard-back-btn"]').click({ force: true });  
...
it("should go to variables setting tab and click on add variable and cancel in UI", () => {
  cy.addDashboard();
    ...
    cy.wait(1000);
      ...
      .type(randomDashboardName);
    cy.wait(2000);
    cy.get('[data-test="dashboard-variable-cancel"]').click({ force: true });
    cy.wait(1000);
      cy.get('[data-test="dashboard-back-btn"]').click({ force: true }); 
    cy.wait(2000)
      cy.get('[data-test="menu-link-/dashboards-item"]').click({ force: true})
