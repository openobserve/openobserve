...
export class LogsPage {
    ...
    // ============================================================================
    // Methods added for regression tests (v0.40)
    // ============================================================================
     ...
     * @returns {Promise<string[]>} Array of timestamp strings
     */
    async getTimestampCellValues(limit = 10) {
        const timestampCells = this.page.locator(`${this.logsTable} tbody tr td:first-child`);
        const count = Math.min(await timestampCells.count(), limit);
        const timestamps = [];
        for (let i = 0; i < count; i++) {
     ...
     * @returns {Promise<number>} Number of timestamp cells
     */
    async getTimestampCellCount() {
        const timestampCells = this.page.locator(`${this.logsTable} tbody tr td:first-child`);
        return await timestampCells.count();
    }
