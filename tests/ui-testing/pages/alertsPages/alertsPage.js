...
export class AlertsPage {
    ...
    _initializeLocators() {
        return {
            ...
            tabSql: '[data-test="tab-sql"]',
            tabPromql: '[data-test="tab-promql"]',
            tabBuilder: '[data-test="tab-custom"]',
    ...
    /**
     * Open a new scheduled alert wizard and advance to Step 2 (Query Config).
