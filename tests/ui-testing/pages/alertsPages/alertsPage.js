...
export class AlertsPage {
    constructor(page) {
        ...
        this.tabSql = '[data-test="tab-sql"]';
        this.tabPromql = '[data-test="tab-promql"]';
        this.tabBuilder = '[data-test="tab-custom"]';
        ...
        this.alertDetailsDialog = '[data-test="alert-details-dialog"]';
        this.alertDetailsTitle = '[data-test="alert-details-title"]';
        this.alertDetailsEditButton = '[data-test="alert-details-edit-btn"]';
        this.alertDetailsRefreshButton = '[data-test="alert-details-refresh-btn"]';
        this.alertDetailsCloseButton = '[data-test="alert-details-close-btn"]';
        this.alertDetailsCopyConditionsButton = '[data-test="alert-details-copy-conditions-btn"]';
        this.alertDetailsHistoryTable = '[data-test="alert-details-history-table"]';

        // Evaluation Status Indicator (PR #10470 - "Would Trigger" badge)
        this.alertStatusIndicator = '[data-test="alert-status-indicator"]';
