...
export class AlertTemplatesPage {
  ...
  "text": "{alert_name} is active. This is the alert url {alert_url}. This alert template has been created using a playwright automation script"`;
    ...
    async switchToContentModeTab() {
        // Mode tabs are OToggleGroupItems (reka-ui) rendered as role="radio", NOT role="tab".
        // Use the data-test attribute generated by AppTabs: data-test="tab-{value}".
        const contentTab = this.page.locator('[data-test="tab-content"]');
    ...
    async switchToEmailTypeTab() {
        // Type tabs are OToggleGroupItems (reka-ui) rendered as role="radio".
        // Use the data-test attribute generated by AppTabs: data-test="tab-{value}".
        const emailTab = this.page.locator('[data-test="tab-email"]');
    ...
    async switchToHttpTypeTab() {
        // Type tabs are OToggleGroupItems (reka-ui) rendered as role="radio".
        // Use the data-test attribute generated by AppTabs: data-test="tab-{value}".
        const httpTab = this.page.locator('[data-test="tab-http"]');
        await httpTab.click();
