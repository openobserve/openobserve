...
export class ManagementPage {
  constructor(page) {
    ...
    this.managementMenuItem = page.locator(
    ...
    this.deleteLogoButton = page.locator(
    ...
    this.fileUploadInput = page.locator(
      'input[data-test="setting_ent_custom_logo_img_file_upload"]'
    );
  }
  ...
  async managementPageDefaultMultiOrg() {
    await this.page
      ...
      .click();
    await this.page
      .getByRole("option", { name: "defaulttestmulti" })
      .locator("div")
      .nth(2)
      .click();
  }
