...
export default class DashboardPanelConfigs {
  constructor(page) {
    ...
    this.legend= page.locator('[data-test="dashboard-config-legend-position"]');
    ...
    this.minimumSize = page.locator('[data-test="dashboard-config-map-symbol-min"]');
    this.maximumSize = page.locator('[data-test="dashboard-config-map-symbol-max"]');
    ...
    this.wrapcell = page.locator('[data-test="dashboard-config-wrap-table-cells"]');
    this.transpose = page.locator('[data-test="dashboard-config-table_transpose"]');
    this.dynamicColumn = page.locator('[data-test="dashboard-config-table_dynamic_columns"]');
    this.valueMapping = page.locator('[data-test="dashboard-addpanel-config-drilldown-add-btn"]');
    this.overrideConfig = page.locator('[data-test="dashboard-addpanel-config-override-config-add-btn"]');
...
// //Value mapping
// async selectValueMapping(mapping) {
//   await expect(this.valueMapping).toBeVisible();
//   await this.valueMapping.click();
//   await this.page.locator('[data-test="dashboard-addpanel-config-drilldown-add-btn"] div').nth(2).click();
// }
