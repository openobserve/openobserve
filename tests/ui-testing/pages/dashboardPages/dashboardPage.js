...
export class DashboardPage {
  constructor(page) {
    ...
    // OSwitch renders a <button role="switch"> as its child — no <div> descendants.
    // The -btn suffix is auto-generated by OSwitch from the parent data-test via $attrs.
    this.searchAcrossFoldersToggle = page.locator('[data-test="dashboard-search-across-folders-toggle-btn"]');
