...
test.describe("dashboard UI testcases", () => {
  ...
  test("test dashboard with multiple tabs", async ({ page }) => {
    // Create dashboard
    ...
    // Now open the second tab
    const page2 = await page.context().newPage();
    await runSecondTabSteps(page2);

    await page1.locator('[data-test="menu-link-\\/dashboards-item"]').click();
  await page1.getByRole('cell', { name: 'njsxj' }).click();
  await page1.locator('[data-test="dashboard-edit-panel-test-dropdown"]').click();
  await page1.locator('[data-test="dashboard-edit-panel"]').click();
  await page1.locator('[data-test="dashboard-y-item-kubernetes_container_image-remove"]').click();
  ...
  // await page2.goto('https://playwright.dev');
    ...
    await expect(page.locator("text=Conflict: Failed to save due")).toBeVisible({
      timeout: 5000,
    });
  });
});
