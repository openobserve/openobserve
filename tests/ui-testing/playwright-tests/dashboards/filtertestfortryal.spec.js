...
test.describe("dashboard UI testcases", () => {
  ...
  test("Should  apply the  filter using the field button", async ({ page }) => {
    ...
    await page.locator('[data-test="field-list-item-logs-e2e_automate-kubernetes_namespace_name"] [data-test="dashboard-add-filter-data"]').click();
    await expect(page.locator('[data-test="dashboard-add-condition-label-0-kubernetes_namespace_name"]')).toBeVisible();
