...
test.describe("dashboard maps testcases", () => {
  ...
  test("1should correctly apply the filter conditions with different operators, and successfully apply them to the query", async ({ page }) => {
    ...
    await page.locator('[data-test="dashboard-variable-stream-select"]').fill("geojson");
    await page.getByRole("option", { name: "geojson", exact: true }).click();

    // Select Field
    await page.locator('[data-test="dashboard-variable-field-select"]').click();
    await page.locator('[data-test="dashboard-variable-field-select"]').fill("country");
    await page.getByText("country").click();
    ...
    await page.locator('[data-test="field-list-item-logs-geojson-country"] [data-test="dashboard-add-filter-geomap-data"]').click();
    await page.locator('[data-test="dashboard-apply"]').click();
    ...
    await page.locator('[data-test="dashboard-variable-query-value-selector"]').fill("china");
    ...
    // Save panel
    await page.locator('[data-test="dashboard-panel-name"]').fill("Dashboard_test");
    await page.locator('[data-test="dashboard-panel-save"]').click();
