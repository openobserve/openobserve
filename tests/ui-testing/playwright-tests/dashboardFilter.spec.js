...
await filterButton.click();
    ...
    // Assert that '$variablename' appears on the page
    const expectedVariableName = "$variablename";
    await expect(page.getByText(`'${expectedVariableName}'`)).toBeVisible();
  });
