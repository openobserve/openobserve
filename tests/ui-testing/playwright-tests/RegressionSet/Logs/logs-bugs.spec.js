 ...
 * - #10821: Quick mode toggle not responding to click
 * - #10595: ExpandedRow visible in 2 rows on re-query
 * - #9049: Decimal values accepted in datetime picker
 * - #11606: Include/exclude term added at wrong position
 * - #9339: Index list collapse/expand doesn't redraw histogram
 * - #7310: Search term appended instead of replaced in streams
 * - #5277: Column positions change back after re-query
 * - #4426: Text wrap causes misalignment on saved view switch
