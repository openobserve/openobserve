...
test.describe('Regression: Undefined Length error on Logs -> Scheduled Search -> Streams -> Logs (#7354)', () => {
  ...
  test.beforeEach(async ({ page }, testInfo) => {
    ...
    // Create a search job via API so we have a scheduled search to click on
    ...
    // Store traceId on the page context for the test to use
    page._jobTraceId = traceId;

    // Schedule cleanup of this search job after the test
