...
| --- | --- | --- |
| Fetching data for a page | Never call a service from a component. Read through `web/src/composables/query/` — pick a **tier**, never a `staleTime`. | [references/data-fetching.md](references/data-fetching.md) · [inventory](references/data-fetching-inventory.md) |
