...
mod tests {
    ...
    async fn test_consistent_hashing() {
        ...
        // gxhash hash
        let data = [
            ["test", "node-q-4", "node-c-7"],
            ["test1", "node-q-3", "node-c-3"],
            ["test2", "node-q-7", "node-c-2"],
            ["test3", "node-q-7", "node-c-6"],
            ["test4", "node-q-9", "node-c-3"],
            ["test5", "node-q-5", "node-c-2"],
            ["test6", "node-q-8", "node-c-3"],
        ];
