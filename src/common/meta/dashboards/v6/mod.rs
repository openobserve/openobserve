...
pub struct AxisArg {
    ...
    value: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    aggregation_function: Option<AggregationFunc>,
    #[serde(skip_serializing_if = "Option::is_none")]
    args: Option<Vec<AxisArg>>,
}
...
pub enum AggregationFunc {
    ...
    Sqrt,
    Tan,
    #[serde(rename = "string_length")]
    StringLength,
    #[serde(rename = "char_length")]
    CharLength,
    #[serde(rename = "concat_ws")]
    ConcatWs,
    Lower,
    Upper,
    SubString,
    ...
    DateAdd,
    #[serde(rename = "date_sub")]
    DateSub,
    #[serde(rename = "datediff")]
    DateDiff,
    #[serde(rename = "from_unixtime")]
    FromUnixTime,
    #[serde(rename = "to_unixtime")]
    ToUnixTime,
    #[serde(rename = "array_length")]
    ArrayLength,
    #[serde(rename = "array_sort")]
    ArraySort,
    #[serde(rename = "array_append")]
    ArrayAppend,
