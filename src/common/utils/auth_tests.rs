    ...
    fn mock_config() -> config::Config {
        config::Config {
            ...
            common: config::Common {
                ...
                timestamp_compression_disabled: false,
                ...
                search_around_default_fields: "".to_string(),
                ...
                additional_reporting_orgs: "".to_string(),
            },
            limit: config::Limit {
