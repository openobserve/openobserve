...
mod tests {
    ...
    fn test_label_replace_function() {
        ...
        let mut labels = crate::service::promql::value::Labels::default();
        labels.push(Arc::new(Label::new("instance", "server-123.example.com")));
        labels.push(Arc::new(Label::new("job", "web")));
