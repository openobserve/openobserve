...
// pub async fn get_prompt(id: &str) -> Result<Option<SystemPrompt>, anyhow::Error> {
//     // Use the local table function directly
//     table::system_prompts::get(id, "")
//         .await
//         .map_err(|e| anyhow::anyhow!("{}", e))
// }

// pub async fn list_prompts() -> Result<Vec<SystemPrompt>, anyhow::Error> {
//     // Use the local table function directly
//     table::system_prompts::list("", None)
//         .await
//         .map_err(|e| anyhow::anyhow!("{}", e))
// }
