...
async fn process_stream(
    ...
    let sql = format!(
        r#"SELECT
            ...
            approx_median(server.end_time - server.start_time) / 1000000 AS p50,
            approx_percentile_cont(server.end_time - server.start_time, 0.95) / 1000000 AS p95,
            approx_percentile_cont(server.end_time - server.start_time, 0.99) / 1000000 AS p99
