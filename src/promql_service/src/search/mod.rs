...
use promql::{
    ...
    ast::result_order::top_level_sort_descending, micros,
};
...
pub async fn search(
    ...
    let nodes = search_service::cluster::flight::get_online_querier_nodes(
        trace_id,
        &req.org_id,
        "metrics/",
    ...
    let _lock = search_service::work_group::check_work_group(
        trace_id,
        &req.org_id,
        timeout,
        &mut stop_watch,
