...
/// Sends event to the cluster coordinator indicating that a destination/template has been put
/// into the database.
...
/// Sends event to the cluster coordinator indicating that a destination/template has been
