...
impl From<QuerySearchEventType> for i16 {
    fn from(value: QuerySearchEventType) -> Self {
        match value {
            ...
            QuerySearchEventType::BackgroundJob => QuerySearchEventType::BACKGROUND_JOB,
        }
    }
}
...
impl TryFrom<i16> for QuerySearchEventType {
    ...
    fn try_from(value: i16) -> Result<Self, Self::Error> {
        match value {
            ...
            Self::BACKGROUND_JOB => Ok(QuerySearchEventType::BackgroundJob),
            _ => Err(FromI16Error {
                value,
...
impl From<MetaSearchEventType> for QuerySearchEventType {
    fn from(value: MetaSearchEventType) -> Self {
        match value {
            ...
            MetaSearchEventType::BackgroundJob => Self::BackgroundJob,
        }
    }
}
...
impl From<QuerySearchEventType> for MetaSearchEventType {
    fn from(value: QuerySearchEventType) -> Self {
        match value {
            ...
            QuerySearchEventType::BackgroundJob => Self::BackgroundJob,
        }
    }
}
