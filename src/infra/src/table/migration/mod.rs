...
mod m20251118_000001_create_sessions_table;
mod m20251118_000002_populate_sessions_table;
// mod m20251118_000003_delete_meta_sessions;  // Manual cleanup - run after verification
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20251118_000001_create_sessions_table::Migration),
            Box::new(m20251118_000002_populate_sessions_table::Migration),
