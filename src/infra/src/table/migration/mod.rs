...
mod m20241222_085111_background_jobs;
mod m20241222_085135_background_job_partitions;
mod m20241222_085148_background_job_results;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20241222_085111_background_jobs::Migration),
            Box::new(m20241222_085135_background_job_partitions::Migration),
            Box::new(m20241222_085148_background_job_results::Migration),
        ]
    }
}
