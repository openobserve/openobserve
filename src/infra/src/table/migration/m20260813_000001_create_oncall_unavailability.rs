...
//! Keyed on `(org_id, user_email)`, not a team: somebody on two teams is away from both.
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    ...
                    // No team column, by design — see the module comment.
                    .col(
                    ...
                    // Not always whose absence it is: a lead entering leave is a real flow.
                    .col(
        ...
        // Filtered on `end_at`, which bounds the read; members are narrowed in memory.
        manager
            .create_index(
                Index::create()
                    .if_not_exists()
...
mod tests {
    ...
    async fn test_an_upgraded_database_gains_the_table_too() {
        ...
        // An upgraded database needs the NOT NULL rotation too, or a cover staffs nothing.
