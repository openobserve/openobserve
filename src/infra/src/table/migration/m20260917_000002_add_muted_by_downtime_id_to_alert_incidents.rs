...
const TABLE: &str = "alert_incidents";
const COLUMN: &str = "muted_by_downtime_id";
        ...
        manager
            .alter_table(
                Table::alter()
                    ...
                    .drop_column(AlertIncidents::MutedByDowntimeId)
                    .to_owned(),
            )
            .await
    }
...
fn add_column_statement() -> TableAlterStatement {
    Table::alter()
        .table(AlertIncidents::Table)
        .add_column(
            ColumnDef::new(AlertIncidents::MutedByDowntimeId)
                .string_len(27)
                .null(),
        )
        .to_owned()
