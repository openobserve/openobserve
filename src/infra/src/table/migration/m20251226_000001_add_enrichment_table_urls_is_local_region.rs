...
//! Adds the is_local_region column to enrichment_table_urls table.
//!
//! This column indicates whether the job was created in the current region (true)
//! or received from another region via super_cluster_queue (false).
//! Only local region jobs should be processed by the stale job recovery background task.
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        add_is_local_region_column(manager).await?;
        Ok(())
    }
