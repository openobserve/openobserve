...
pub use super::{
    ...
    alert_incidents::Entity as AlertIncidents, alert_snapshot_files::Entity as AlertSnapshotFiles,
    alert_snapshots::Entity as AlertSnapshots, alerts::Entity as Alerts,
