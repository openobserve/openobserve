...
pub use openobserve_core::traces::db_monitoring::api::{
    ...
    get_dbm_queries, get_dbm_query_endpoints, get_dbm_query_history, get_dbm_query_insights,
    get_dbm_query_plans, get_dbm_query_server_metrics, get_dbm_samples, get_dbm_server_queries,
    get_dbm_server_samples, get_dbm_table_health,
};
