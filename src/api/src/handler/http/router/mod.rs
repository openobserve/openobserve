...
pub fn service_routes() -> Router {
    ...
    router = router.route("/{org_id}/users", get(users::list).post(users::save))
        ...
        .route("/v2/{org_id}/alerts/{alert_id}/occurrences", get(alerts::occurrences::list_alert_occurrences))
        .route("/v2/{org_id}/alerts/occurrences/{occurrence_id}", get(alerts::occurrences::get_alert_occurrence))
