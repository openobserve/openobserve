...
#[openapi(
    paths(
        ...
        request::alerts::snapshots::get_alert_snapshot_manifest,
    ...
    components(
        schemas(
            ...
            crate::handler::http::models::alerts::responses::AlertSnapshotManifestResponseBody,
            crate::handler::http::models::alerts::responses::AlertSnapshotStreamResponseBody,
            crate::handler::http::models::alerts::responses::AlertSnapshotFileRefResponseBody,
