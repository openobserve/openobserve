...
pub async fn get_built_in(
    ...
    let last_updated = openobserve_ingestion::repository::model_pricing_sync::last_sync_timestamp();
...
pub async fn refresh_built_in(
    ...
    let last_sync = openobserve_ingestion::repository::model_pricing_sync::last_sync_timestamp();
    ...
    match openobserve_ingestion::repository::model_pricing_sync::sync_built_in_from_github(true)
        .await
    {
