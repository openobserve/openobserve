...
#[openapi(
    paths(
        ...
        openobserve_api_management::request::alerts::incidents::ingest_external_alert,
    ...
    components(
        schemas(
            ...
            config::meta::alerts::incidents::ExternalAlertStatus,
            config::meta::alerts::incidents::ExternalIngestResponse,
            config::meta::alerts::incidents::ExternalIngestAction,
