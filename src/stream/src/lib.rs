...
pub async fn stream_delete_inner(
    ...
    #[cfg(feature = "vectorscan")]
    {
        use db::re_pattern::remove_stream_associations_after_deletion;
...
pub async fn delete_stream_data_by_time_range(
    ...
    let (key, _created) = match db::compact::retention::delete_stream(
        org_id,
        stream_type,
        stream_name,
    ...
    db::compact::compactor_manual_jobs::add_job(job).await
}
