        ...
        if let Some(manager) = prompt_manager_singleton::get() {
            ...
            let response: Vec<TemplateResponse> = templates
                ...
                .map(|t| TemplateResponse {
                    ...
                    fail_patterns: t.fail_patterns,
                    pass_patterns: t.pass_patterns,
                    version: t.version,
    ...
    #[cfg(feature = "enterprise")]
    {
        ...
        if let Some(manager) = prompt_manager_singleton::get() {
            ...
            let template = o2_enterprise::enterprise::ai::evaluation::prompt_manager::EvalPrompt {
                ...
                fail_patterns: req.fail_patterns,
                pass_patterns: req.pass_patterns,
                version: 1,
                is_active: true,
                created_at: now,
                updated_at: now,
            ...
            let db_template = db_eval_templates::EvalTemplate {
                ...
                fail_patterns: template.fail_patterns.clone(),
                pass_patterns: template.pass_patterns.clone(),
            ...
            match manager.update_template(template.clone()).await {
                Ok(_) => {
                    let response = TemplateResponse {
                        ...
                        fail_patterns: template.fail_patterns,
                        pass_patterns: template.pass_patterns,
                        version: template.version,
                        is_active: template.is_active,
                        created_at: template.created_at,
                        updated_at: template.updated_at,
