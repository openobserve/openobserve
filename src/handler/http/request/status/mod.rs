...
pub async fn cache_status() -> impl IntoResponse {
    ...
    // Config caches from crates/openobserve-core/src/common/infra/config.rs
    ...
    // File list caches (2) from crates/openobserve-core/src/service/db/file_list/mod.rs
    ...
    // crates/openobserve-core/src/service/db/compact/organization.rs line 21
