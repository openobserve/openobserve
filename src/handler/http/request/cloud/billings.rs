...
fn map_country_to_tax_id_type(country: &str) -> Option<o2_enterprise::enterprise::cloud::billings::TaxIdTypeFilter> {
    ...
    match country.to_uppercase().as_str() {
        // EU VAT
        "AT" => Some(TaxIdTypeFilter::EuVat),
        "BE" => Some(TaxIdTypeFilter::EuVat),
        "BG" => Some(TaxIdTypeFilter::EuVat),
        "HR" => Some(TaxIdTypeFilter::EuVat),
        "CY" => Some(TaxIdTypeFilter::EuVat),
        "CZ" => Some(TaxIdTypeFilter::EuVat),
        "DK" => Some(TaxIdTypeFilter::EuVat),
        "EE" => Some(TaxIdTypeFilter::EuVat),
        "FI" => Some(TaxIdTypeFilter::EuVat),
        "FR" => Some(TaxIdTypeFilter::EuVat),
        "DE" => Some(TaxIdTypeFilter::EuVat),
        "GR" => Some(TaxIdTypeFilter::EuVat),
        "HU" => Some(TaxIdTypeFilter::EuVat),
        "IE" => Some(TaxIdTypeFilter::EuVat),
        "IT" => Some(TaxIdTypeFilter::EuVat),
        "LV" => Some(TaxIdTypeFilter::EuVat),
        "LT" => Some(TaxIdTypeFilter::EuVat),
        "LU" => Some(TaxIdTypeFilter::EuVat),
        "MT" => Some(TaxIdTypeFilter::EuVat),
        "NL" => Some(TaxIdTypeFilter::EuVat),
        "PL" => Some(TaxIdTypeFilter::EuVat),
        "PT" => Some(TaxIdTypeFilter::EuVat),
        "RO" => Some(TaxIdTypeFilter::EuVat),
        "SK" => Some(TaxIdTypeFilter::EuVat),
        "SI" => Some(TaxIdTypeFilter::EuVat),
        "ES" => Some(TaxIdTypeFilter::EuVat),
        "SE" => Some(TaxIdTypeFilter::EuVat),
        // Non-EU European
        "GB" => Some(TaxIdTypeFilter::GbVat),
        "CH" => Some(TaxIdTypeFilter::ChVat),
        "NO" => Some(TaxIdTypeFilter::NoVat),
        // Americas
        "US" => Some(TaxIdTypeFilter::UsEin),
        "CA" => Some(TaxIdTypeFilter::CaBn),
        "MX" => Some(TaxIdTypeFilter::MxRfc),
        "BR" => Some(TaxIdTypeFilter::BrCnpj),
        "CL" => Some(TaxIdTypeFilter::ClTin),
        // Asia Pacific
        "AU" => Some(TaxIdTypeFilter::AuAbn),
        "NZ" => Some(TaxIdTypeFilter::NzGst),
        "IN" => Some(TaxIdTypeFilter::InGst),
        "SG" => Some(TaxIdTypeFilter::SgGst),
        "HK" => Some(TaxIdTypeFilter::HkBr),
        "MY" => Some(TaxIdTypeFilter::MyItn),
        "TH" => Some(TaxIdTypeFilter::ThVat),
        "ID" => Some(TaxIdTypeFilter::IdNpwp),
        "TW" => Some(TaxIdTypeFilter::TwVat),
        "KR" => Some(TaxIdTypeFilter::KrBrn),
        "JP" => Some(TaxIdTypeFilter::JpCn),
        // Middle East & Africa
        "AE" => Some(TaxIdTypeFilter::AeTrn),
        "SA" => Some(TaxIdTypeFilter::SaVat),
        "ZA" => Some(TaxIdTypeFilter::ZaVat),
        "IL" => Some(TaxIdTypeFilter::IlVat),
        // Other regions
        "IS" => Some(TaxIdTypeFilter::IsVat),
        "LI" => Some(TaxIdTypeFilter::LiUid),
        "RU" => Some(TaxIdTypeFilter::RuInn),
        "TR" => Some(TaxIdTypeFilter::TrTin),
        _ => None,
    }
}
