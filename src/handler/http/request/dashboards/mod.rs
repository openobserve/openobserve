...
pub async fn create_dashboard(
    ...
    let resp_body: CreateDashboardResponseBody = match saved.try_into() {
        Ok(resp_body) => resp_body,
        Err(err) => return MetaHttpResponse::internal_error(err),
    };
...
async fn update_dashboard(
    ...
    let resp_body: UpdateDashboardResponseBody = match saved.try_into() {
        Ok(resp_body) => resp_body,
        Err(err) => return MetaHttpResponse::internal_error(err),
    };
    MetaHttpResponse::json(resp_body)
...
async fn list_dashboards(org_id: web::Path<String>, req: HttpRequest) -> impl Responder {
    ...
    let resp_body: ListDashboardsResponseBody = match dashboards.try_into() {
        Ok(resp_body) => resp_body,
        Err(err) => return MetaHttpResponse::internal_error(err),
    };
    MetaHttpResponse::json(resp_body)
...
async fn get_dashboard(path: web::Path<(String, String)>, req: HttpRequest) -> impl Responder {
    ...
    let resp_body: GetDashboardResponseBody = match dashboard.try_into() {
        Ok(resp_body) => resp_body,
        Err(err) => return MetaHttpResponse::internal_error(err),
    };
    MetaHttpResponse::json(resp_body)
