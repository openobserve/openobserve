...
#[utoipa::path(
    ...
    extensions(
        ...
        ("x-o2-mcp" = json!({"description": "Create time annotations for dashboards. Annotations mark events/incidents on dashboard panels at specific timestamps.", "category": "dashboards"}))
    )
)]
