...
#[openapi(
    ...
    components(
        schemas(
            ...
            crate::handler::http::models::stream::StreamType,
            ...
            // Alerts
            crate::handler::http::models::alerts::requests::SaveAlertRequestBody,
            crate::handler::http::models::alerts::requests::UpdateAlertRequestBody,
            crate::handler::http::models::alerts::requests::SaveDestinationRequestBody,
            crate::handler::http::models::alerts::requests::UpdateDestinationRequestBody,
            crate::handler::http::models::alerts::requests::SaveTemplateRequestBody,
            crate::handler::http::models::alerts::requests::UpdateTemplateRequestBody,
            crate::handler::http::models::alerts::responses::ListStreamAlertsResponseBody,
            ...
            crate::handler::http::models::alerts::responses::GetDestinationResponseBody,
            crate::handler::http::models::alerts::responses::ListDestinationsResponseBody,
            crate::handler::http::models::alerts::responses::GetTemplateResponseBody,
            crate::handler::http::models::alerts::responses::ListTemplatesResponseBody,
            crate::handler::http::models::alerts::alert::Alert,
            crate::handler::http::models::alerts::alert::TriggerCondition,
            crate::handler::http::models::alerts::alert::CompareHistoricData,
            crate::handler::http::models::alerts::alert::FrequencyType,
            crate::handler::http::models::alerts::alert::QueryCondition,
            crate::handler::http::models::alerts::alert::Aggregation,
            crate::handler::http::models::alerts::destinations::Destination,
            crate::handler::http::models::alerts::destinations::DestinationType,
            crate::handler::http::models::alerts::destinations::HTTPType,
            crate::handler::http::models::alerts::templates::Template,
            // Folders
            ...
            crate::handler::http::models::search::SearchEventType,
