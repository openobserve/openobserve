...
#[openapi(
    paths(
        ...
        request::scheduled_ops::alerts::save_alert,
        request::scheduled_ops::alerts::update_alert,
        request::scheduled_ops::alerts::list_stream_alerts,
        request::scheduled_ops::alerts::list_alerts,
        request::scheduled_ops::alerts::get_alert,
        request::scheduled_ops::alerts::delete_alert,
        request::scheduled_ops::alerts::enable_alert,
        request::scheduled_ops::alerts::trigger_alert,
        request::scheduled_ops::derived_streams::save,
        request::scheduled_ops::derived_streams::update_derived_streams,
        request::scheduled_ops::derived_streams::list_derived_streams,
        request::scheduled_ops::derived_streams::get_derived_streams,
        request::scheduled_ops::derived_streams::delete_derived_streams,
        request::scheduled_ops::derived_streams::enable_derived_streams,
        request::scheduled_ops::derived_streams::trigger_derived_streams,
        request::scheduled_ops::templates::list_templates,
        request::scheduled_ops::templates::get_template,
        request::scheduled_ops::templates::save_template,
        request::scheduled_ops::templates::update_template,
        request::scheduled_ops::templates::delete_template,
        request::scheduled_ops::destinations::list_destinations,
        request::scheduled_ops::destinations::get_destination,
        request::scheduled_ops::destinations::save_destination,
        request::scheduled_ops::destinations::update_destination,
        request::scheduled_ops::destinations::delete_destination,
        request::kv::get,
        request::kv::set,
        request::kv::delete,
        request::kv::list,
    ...
    components(
        schemas(
            ...
            meta::scheduled_ops::alerts::Alert,
            meta::scheduled_ops::Condition,
            meta::scheduled_ops::Operator,
            meta::scheduled_ops::Aggregation,
            ...
            meta::scheduled_ops::destinations::HTTPType,
            meta::scheduled_ops::destinations::DestinationType,
            meta::scheduled_ops::templates::Template,
