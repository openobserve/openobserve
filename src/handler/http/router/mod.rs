...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(alerts::scripts::save_script)
            .service(alerts::scripts::update_script)
            .service(alerts::scripts::get_script)
            .service(alerts::scripts::delete_script)
            .service(alerts::scripts::list_scripts)
