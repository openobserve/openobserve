...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(organization::settings::get_custom_settings)
            .service(organization::settings::set_custom_settings)
            .service(organization::settings::update_custom_settings)
            .service(organization::settings::delete_custom_settings)
