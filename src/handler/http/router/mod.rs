...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(organization::org_es_index)
            .service(organization::org_es_license)
            .service(organization::org_es_xpack)
            .service(organization::org_es_index_template)
            .service(organization::org_es_index_template_create)
            .service(organization::org_es_data_stream)
            .service(organization::org_es_data_stream_create)
