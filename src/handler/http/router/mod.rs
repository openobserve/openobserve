...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(synthetics::create_synthetics)
            .service(synthetics::update_synthetic)
            .service(synthetics::list_synthetics)
            .service(synthetics::get_synthetics)
            .service(synthetics::delete_synthetics)
            .service(synthetics::enable_synthetics)
            .service(synthetics::trigger_synthetics)
            .service(kv::get)
            .service(kv::set)
            .service(kv::delete)
            .service(kv::list)
