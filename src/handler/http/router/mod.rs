...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(alerts::alerts::save_alert)
            .service(alerts::alerts::update_alert)
            .service(alerts::alerts::get_alert)
            .service(alerts::alerts::list_alerts)
            .service(alerts::alerts::list_stream_alerts)
            .service(alerts::alerts::delete_alert)
            .service(alerts::alerts::enable_alert)
            .service(alerts::alerts::trigger_alert)
