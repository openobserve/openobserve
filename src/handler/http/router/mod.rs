...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(search::background_job::submit_query)
            .service(search::background_job::query_status_all)
            .service(search::background_job::query_status)
            .service(search::background_job::get_query_result)
            .service(search::background_job::cancel_query)
            .service(search::background_job::delete_query)
            .service(search::background_job::retry_query)
