...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(scheduled_ops::alerts::save_alert)
            .service(scheduled_ops::alerts::update_alert)
            .service(scheduled_ops::alerts::get_alert)
            .service(scheduled_ops::alerts::list_alerts)
            .service(scheduled_ops::alerts::list_stream_alerts)
            .service(scheduled_ops::alerts::delete_alert)
            .service(scheduled_ops::alerts::enable_alert)
            .service(scheduled_ops::alerts::trigger_alert)
            .service(scheduled_ops::derived_streams::save)
            .service(scheduled_ops::derived_streams::update_derived_streams)
            .service(scheduled_ops::derived_streams::list_derived_streams)
            .service(scheduled_ops::derived_streams::get_derived_streams)
            .service(scheduled_ops::derived_streams::delete_derived_streams)
            .service(scheduled_ops::derived_streams::enable_derived_streams)
            .service(scheduled_ops::derived_streams::trigger_derived_streams)
            .service(scheduled_ops::templates::save_template)
            .service(scheduled_ops::templates::update_template)
            .service(scheduled_ops::templates::get_template)
            .service(scheduled_ops::templates::delete_template)
            .service(scheduled_ops::templates::list_templates)
            .service(scheduled_ops::destinations::save_destination)
            .service(scheduled_ops::destinations::update_destination)
            .service(scheduled_ops::destinations::get_destination)
            .service(scheduled_ops::destinations::list_destinations)
            .service(scheduled_ops::destinations::delete_destination)
            .service(kv::get)
            .service(kv::set)
            .service(kv::delete)
            .service(kv::list)
