...
mod tests {
    ...
    async fn test_subquery() -> Result<()> {
        ...
        let expected = vec![
            ...
            "        HashJoinExec: mode=CollectLeft, join_type=LeftSemi, on=[(name@0, name@0)], projection=[]",
    ...
    async fn test_join_three_table() -> Result<()> {
        ...
        let expected = vec![
            ...
            "  HashJoinExec: mode=CollectLeft, join_type=Inner, on=[(usr_id@0, usr_id@0)], projection=[usr_id@2, prod_id@1]",
