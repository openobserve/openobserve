...
impl Dashboard {
    make_getter!(dashboard_id; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);
    make_setter!(dashboard_id; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);

    make_getter!(owner; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);
    make_setter!(owner; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);

    make_getter!(title; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);
    make_setter!(title; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);

    make_getter!(description; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);
    make_getter!(role; 1 v1, 2 v2, 3 v3, 4 v4, 5 v5, 6 v6);
    ...
    /// was created.
    ///
    /// This value is stored in JSON for versions 1-6 of the dashboard. However
