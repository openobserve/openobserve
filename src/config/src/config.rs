...
pub struct Common {
    ...
    #[env_config(
        name = "ZO_TRACES_OTEL_LLM_TRANSFORM_ENABLED",
        default = false,
        help = "enable OTEL LLM transform for trace enrichment with LLM observability attributes"
    )]
    pub traces_otel_llm_transform_enabled: bool,
    #[env_config(
