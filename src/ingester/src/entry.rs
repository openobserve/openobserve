...
use config::utils::record_batch_ext::{RecordBatchExt, convert_json_to_record_batch_optimized};
...
impl Entry {
    ...
    pub fn into_batch(
        ...
        let batch = convert_json_to_record_batch_optimized(&schema, &self.data)
