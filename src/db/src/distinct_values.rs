...
mod tests {
    ...
    mod enterprise_tests {
        ...
        async fn test_emit_put_event() {
            ...
            let result = crate::distinct_values::emit_put_event(&record).await;
        ...
        async fn test_emit_delete_event() {
            ...
            let result = crate::distinct_values::emit_delete_event(&record).await;
            assert!(result.is_ok() || result.is_err());
        }
        ...
        async fn test_emit_batch_delete_event() {
            let result =
                crate::distinct_values::emit_batch_delete_event(&OriginType::Stream, "test_id")
                    .await;
            assert!(result.is_ok() || result.is_err());
        }
    }
