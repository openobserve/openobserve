...
/// Payload: `(batch_id, new_files, retire_files)`; only `retire_files` leave `file_list`.
                ...
                loop {
                    ...
                    match ret {
                        ...
                        Some(job) => {
                            ...
                            db::compact::stream::clear_running(&key);
                        }
                    }
                }
            });
                        ...
                        Some((tx, msg)) => {
                            ...
                            .await
                            {
                                Ok((new_files, retire_files)) => {
                                    if let Err(e) =
                                        tx.send(Ok((msg.batch_id, new_files, retire_files))).await
                                    {
                                        log::error!(
